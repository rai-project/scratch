...
from google.privacy.dlp.v2beta1 import storage_pb2 as google_dot_privacy_dot_dlp_dot_v2beta1_dot_storage__pb2
...
_INSPECTCONFIG_INFOTYPELIMIT.fields_by_name['info_type'].message_type = google_dot_privacy_dot_dlp_dot_v2beta1_dot_storage__pb2._INFOTYPE
_INSPECTCONFIG_INFOTYPELIMIT.containing_type = _INSPECTCONFIG
_INSPECTCONFIG.fields_by_name['info_types'].message_type = google_dot_privacy_dot_dlp_dot_v2beta1_dot_storage__pb2._INFOTYPE
...
_TABLE.fields_by_name['headers'].message_type = google_dot_privacy_dot_dlp_dot_v2beta1_dot_storage__pb2._FIELDID
_TABLE.fields_by_name['rows'].message_type = _TABLE_ROW
_INSPECTRESULT.fields_by_name['findings'].message_type = _FINDING
_FINDING.fields_by_name['info_type'].message_type = google_dot_privacy_dot_dlp_dot_v2beta1_dot_storage__pb2._INFOTYPE
...
_LOCATION.fields_by_name['record_key'].message_type = google_dot_privacy_dot_dlp_dot_v2beta1_dot_storage__pb2._RECORDKEY
_LOCATION.fields_by_name['field_id'].message_type = google_dot_privacy_dot_dlp_dot_v2beta1_dot_storage__pb2._FIELDID
_LOCATION.fields_by_name['table_location'].message_type = _TABLELOCATION
_REDACTCONTENTREQUEST_REPLACECONFIG.fields_by_name['info_type'].message_type = google_dot_privacy_dot_dlp_dot_v2beta1_dot_storage__pb2._INFOTYPE
_REDACTCONTENTREQUEST_REPLACECONFIG.containing_type = _REDACTCONTENTREQUEST
_REDACTCONTENTREQUEST_IMAGEREDACTIONCONFIG.fields_by_name['info_type'].message_type = google_dot_privacy_dot_dlp_dot_v2beta1_dot_storage__pb2._INFOTYPE
...
_CREATEINSPECTOPERATIONREQUEST.fields_by_name['storage_config'].message_type = google_dot_privacy_dot_dlp_dot_v2beta1_dot_storage__pb2._STORAGECONFIG
...
_OUTPUTSTORAGECONFIG.fields_by_name['table'].message_type = google_dot_privacy_dot_dlp_dot_v2beta1_dot_storage__pb2._BIGQUERYTABLE
_OUTPUTSTORAGECONFIG.fields_by_name['storage_path'].message_type = google_dot_privacy_dot_dlp_dot_v2beta1_dot_storage__pb2._CLOUDSTORAGEPATH
...
_INFOTYPESTATISTICS.fields_by_name['info_type'].message_type = google_dot_privacy_dot_dlp_dot_v2beta1_dot_storage__pb2._INFOTYPE
...
_INSPECTOPERATIONMETADATA.fields_by_name['request_storage_config'].message_type = google_dot_privacy_dot_dlp_dot_v2beta1_dot_storage__pb2._STORAGECONFIG
...
InspectConfig = _reflection.GeneratedProtocolMessageType('InspectConfig', (_message.Message,), dict(
  ...
  InfoTypeLimit = _reflection.GeneratedProtocolMessageType('InfoTypeLimit', (_message.Message,), dict(
    ...
    __module__ = 'google.privacy.dlp.v2beta1.dlp_pb2'
...
_DLPSERVICE = _descriptor.ServiceDescriptor(
  name='DlpService',
  full_name='google.privacy.dlp.v2beta1.DlpService',
  file=DESCRIPTOR,
  index=0,
  options=None,
  ...
  _descriptor.MethodDescriptor(
    name='InspectContent',
    full_name='google.privacy.dlp.v2beta1.DlpService.InspectContent',
    index=0,
    containing_service=None,
    input_type=_INSPECTCONTENTREQUEST,
    output_type=_INSPECTCONTENTRESPONSE,
    options=_descriptor._ParseOptions(descriptor_pb2.MethodOptions(), _b('\202\323\344\223\002\035\"\030/v2beta1/content:inspect:\001*')),
  ),
  _descriptor.MethodDescriptor(
    name='RedactContent',
    full_name='google.privacy.dlp.v2beta1.DlpService.RedactContent',
    index=1,
    containing_service=None,
    input_type=_REDACTCONTENTREQUEST,
    output_type=_REDACTCONTENTRESPONSE,
    options=_descriptor._ParseOptions(descriptor_pb2.MethodOptions(), _b('\202\323\344\223\002\034\"\027/v2beta1/content:redact:\001*')),
  ),
  _descriptor.MethodDescriptor(
    name='CreateInspectOperation',
    full_name='google.privacy.dlp.v2beta1.DlpService.CreateInspectOperation',
    index=2,
    containing_service=None,
    input_type=_CREATEINSPECTOPERATIONREQUEST,
    output_type=google_dot_longrunning_dot_operations__pb2._OPERATION,
    options=_descriptor._ParseOptions(descriptor_pb2.MethodOptions(), _b('\202\323\344\223\002 \"\033/v2beta1/inspect/operations:\001*')),
  ),
  _descriptor.MethodDescriptor(
    name='ListInspectFindings',
    full_name='google.privacy.dlp.v2beta1.DlpService.ListInspectFindings',
    index=3,
    containing_service=None,
    input_type=_LISTINSPECTFINDINGSREQUEST,
    output_type=_LISTINSPECTFINDINGSRESPONSE,
    options=_descriptor._ParseOptions(descriptor_pb2.MethodOptions(), _b('\202\323\344\223\002,\022*/v2beta1/{name=inspect/results/*}/findings')),
  ),
  _descriptor.MethodDescriptor(
    name='ListInfoTypes',
    full_name='google.privacy.dlp.v2beta1.DlpService.ListInfoTypes',
    index=4,
    containing_service=None,
    input_type=_LISTINFOTYPESREQUEST,
    output_type=_LISTINFOTYPESRESPONSE,
    options=_descriptor._ParseOptions(descriptor_pb2.MethodOptions(), _b('\202\323\344\223\0020\022./v2beta1/rootCategories/{category=*}/infoTypes')),
  ),
  _descriptor.MethodDescriptor(
    name='ListRootCategories',
    full_name='google.privacy.dlp.v2beta1.DlpService.ListRootCategories',
    index=5,
    containing_service=None,
    input_type=_LISTROOTCATEGORIESREQUEST,
    output_type=_LISTROOTCATEGORIESRESPONSE,
    options=_descriptor._ParseOptions(descriptor_pb2.MethodOptions(), _b('\202\323\344\223\002\031\022\027/v2beta1/rootCategories')),
  ),
])
