...
AnnotateVideoRequest = _reflection.GeneratedProtocolMessageType('AnnotateVideoRequest', (_message.Message,), dict(
  ...
  __module__ = 'google.cloud.videointelligence.v1beta1.video_intelligence_pb2'
