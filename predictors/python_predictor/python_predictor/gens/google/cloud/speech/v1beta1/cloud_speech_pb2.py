...
_SPEECH = _descriptor.ServiceDescriptor(
  name='Speech',
  full_name='google.cloud.speech.v1beta1.Speech',
  file=DESCRIPTOR,
  index=0,
  options=None,
  ...
  _descriptor.MethodDescriptor(
    name='SyncRecognize',
    full_name='google.cloud.speech.v1beta1.Speech.SyncRecognize',
    index=0,
    containing_service=None,
    input_type=_SYNCRECOGNIZEREQUEST,
    output_type=_SYNCRECOGNIZERESPONSE,
    options=_descriptor._ParseOptions(descriptor_pb2.MethodOptions(), _b('\202\323\344\223\002\"\"\035/v1beta1/speech:syncrecognize:\001*')),
  ),
  _descriptor.MethodDescriptor(
    name='AsyncRecognize',
    full_name='google.cloud.speech.v1beta1.Speech.AsyncRecognize',
    index=1,
    containing_service=None,
    input_type=_ASYNCRECOGNIZEREQUEST,
    output_type=google_dot_longrunning_dot_operations__pb2._OPERATION,
    options=_descriptor._ParseOptions(descriptor_pb2.MethodOptions(), _b('\202\323\344\223\002#\"\036/v1beta1/speech:asyncrecognize:\001*')),
  ),
  _descriptor.MethodDescriptor(
    name='StreamingRecognize',
    full_name='google.cloud.speech.v1beta1.Speech.StreamingRecognize',
    index=2,
    containing_service=None,
