...
_MODELSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    output_type=_MODEL,
    options=_descriptor._ParseOptions(descriptor_pb2.MethodOptions(), _b('\202\323\344\223\002\'\"\036/v1/{parent=projects/*}/models:\005model')),
  ),
  _descriptor.MethodDescriptor(
    name='ListModels',
    ...
    options=_descriptor._ParseOptions(descriptor_pb2.MethodOptions(), _b('\202\323\344\223\002 \022\036/v1/{parent=projects/*}/models')),
  ),
  _descriptor.MethodDescriptor(
    name='GetModel',
    ...
    output_type=_MODEL,
    options=_descriptor._ParseOptions(descriptor_pb2.MethodOptions(), _b('\202\323\344\223\002 \022\036/v1/{name=projects/*/models/*}')),
  ),
  _descriptor.MethodDescriptor(
    name='DeleteModel',
    ...
    options=_descriptor._ParseOptions(descriptor_pb2.MethodOptions(), _b('\202\323\344\223\002 *\036/v1/{name=projects/*/models/*}')),
  ),
  _descriptor.MethodDescriptor(
    name='CreateVersion',
    ...
    output_type=google_dot_longrunning_dot_operations__pb2._OPERATION,
    options=_descriptor._ParseOptions(descriptor_pb2.MethodOptions(), _b('\202\323\344\223\0024\")/v1/{parent=projects/*/models/*}/versions:\007version')),
  ),
  _descriptor.MethodDescriptor(
    name='ListVersions',
    ...
    options=_descriptor._ParseOptions(descriptor_pb2.MethodOptions(), _b('\202\323\344\223\002+\022)/v1/{parent=projects/*/models/*}/versions')),
  ),
  _descriptor.MethodDescriptor(
    name='GetVersion',
    ...
    options=_descriptor._ParseOptions(descriptor_pb2.MethodOptions(), _b('\202\323\344\223\002+\022)/v1/{name=projects/*/models/*/versions/*}')),
  ),
  _descriptor.MethodDescriptor(
    name='DeleteVersion',
    ...
    output_type=google_dot_longrunning_dot_operations__pb2._OPERATION,
    options=_descriptor._ParseOptions(descriptor_pb2.MethodOptions(), _b('\202\323\344\223\002+*)/v1/{name=projects/*/models/*/versions/*}')),
  ),
  _descriptor.MethodDescriptor(
    ...
    output_type=_VERSION,
    options=_descriptor._ParseOptions(descriptor_pb2.MethodOptions(), _b('\202\323\344\223\0029\"4/v1/{name=projects/*/models/*/versions/*}:setDefault:\001*')),
  ),
])
...
try:
  ...
  def beta_create_ModelService_server(servicer, pool=None, pool_size=None, default_timeout=None, maximum_timeout=None):
    ...
    request_deserializers = {
      ('google.cloud.ml.v1.ModelService', 'CreateModel'): CreateModelRequest.FromString,
      ('google.cloud.ml.v1.ModelService', 'CreateVersion'): CreateVersionRequest.FromString,
      ('google.cloud.ml.v1.ModelService', 'DeleteModel'): DeleteModelRequest.FromString,
      ('google.cloud.ml.v1.ModelService', 'DeleteVersion'): DeleteVersionRequest.FromString,
      ('google.cloud.ml.v1.ModelService', 'GetModel'): GetModelRequest.FromString,
      ('google.cloud.ml.v1.ModelService', 'GetVersion'): GetVersionRequest.FromString,
      ('google.cloud.ml.v1.ModelService', 'ListModels'): ListModelsRequest.FromString,
      ('google.cloud.ml.v1.ModelService', 'ListVersions'): ListVersionsRequest.FromString,
      ('google.cloud.ml.v1.ModelService', 'SetDefaultVersion'): SetDefaultVersionRequest.FromString,
    }
    response_serializers = {
      ('google.cloud.ml.v1.ModelService', 'CreateModel'): Model.SerializeToString,
      ('google.cloud.ml.v1.ModelService', 'CreateVersion'): google_dot_longrunning_dot_operations__pb2.Operation.SerializeToString,
      ('google.cloud.ml.v1.ModelService', 'DeleteModel'): google_dot_longrunning_dot_operations__pb2.Operation.SerializeToString,
      ('google.cloud.ml.v1.ModelService', 'DeleteVersion'): google_dot_longrunning_dot_operations__pb2.Operation.SerializeToString,
      ('google.cloud.ml.v1.ModelService', 'GetModel'): Model.SerializeToString,
      ('google.cloud.ml.v1.ModelService', 'GetVersion'): Version.SerializeToString,
      ('google.cloud.ml.v1.ModelService', 'ListModels'): ListModelsResponse.SerializeToString,
      ('google.cloud.ml.v1.ModelService', 'ListVersions'): ListVersionsResponse.SerializeToString,
      ('google.cloud.ml.v1.ModelService', 'SetDefaultVersion'): Version.SerializeToString,
    }
    method_implementations = {
      ('google.cloud.ml.v1.ModelService', 'CreateModel'): face_utilities.unary_unary_inline(servicer.CreateModel),
      ('google.cloud.ml.v1.ModelService', 'CreateVersion'): face_utilities.unary_unary_inline(servicer.CreateVersion),
      ('google.cloud.ml.v1.ModelService', 'DeleteModel'): face_utilities.unary_unary_inline(servicer.DeleteModel),
      ('google.cloud.ml.v1.ModelService', 'DeleteVersion'): face_utilities.unary_unary_inline(servicer.DeleteVersion),
      ('google.cloud.ml.v1.ModelService', 'GetModel'): face_utilities.unary_unary_inline(servicer.GetModel),
      ('google.cloud.ml.v1.ModelService', 'GetVersion'): face_utilities.unary_unary_inline(servicer.GetVersion),
      ('google.cloud.ml.v1.ModelService', 'ListModels'): face_utilities.unary_unary_inline(servicer.ListModels),
      ('google.cloud.ml.v1.ModelService', 'ListVersions'): face_utilities.unary_unary_inline(servicer.ListVersions),
      ('google.cloud.ml.v1.ModelService', 'SetDefaultVersion'): face_utilities.unary_unary_inline(servicer.SetDefaultVersion),
    }
  ...
  def beta_create_ModelService_stub(channel, host=None, metadata_transformer=None, pool=None, pool_size=None):
    ...
    return beta_implementations.dynamic_stub(channel, 'google.cloud.ml.v1.ModelService', cardinalities, options=stub_options)
except ImportError:
  pass
