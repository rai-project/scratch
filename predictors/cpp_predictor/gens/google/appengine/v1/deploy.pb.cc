...
namespace appengine {
namespace v1 {
class Deployment_FilesEntryDefaultTypeInternal {
public:
 ::google::protobuf::internal::ExplicitlyConstructed<Deployment::Deployment_FilesEntry>
     _instance;
...
file_level_metadata[0].reflection = Deployment::Deployment_FilesEntry::CreateReflection(file_level_metadata[0].descriptor, _Deployment_FilesEntry_default_instance_._instance.get_mutable());
}
...
void TableStruct::InitDefaultsImpl() {
  ...
  _Deployment_FilesEntry_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_Deployment_FilesEntry_default_instance_);_Deployment_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_Deployment_default_instance_);_FileInfo_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_FileInfo_default_instance_);_ContainerInfo_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_ContainerInfo_default_instance_);_ZipInfo_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_ZipInfo_default_instance_);_Deployment_FilesEntry_default_instance_._instance.get_mutable()->set_default_instance(_Deployment_FilesEntry_default_instance_._instance.get_mutable());
  _Deployment_FilesEntry_default_instance_._instance.get_mutable()->InitAsDefaultInstance();
  _Deployment_default_instance_._instance.get_mutable()->container_ = const_cast< ::google::appengine::v1::ContainerInfo*>(
      ::google::appengine::v1::ContainerInfo::internal_default_instance());
  _Deployment_default_instance_._instance.get_mutable()->zip_ = const_cast< ::google::appengine::v1::ZipInfo*>(
