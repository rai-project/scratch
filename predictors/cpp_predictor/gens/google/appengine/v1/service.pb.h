...
class TrafficSplit_AllocationsEntry;
class TrafficSplit_AllocationsEntryDefaultTypeInternal;
extern TrafficSplit_AllocationsEntryDefaultTypeInternal _TrafficSplit_AllocationsEntry_default_instance_;
}  // namespace v1
}  // namespace appengine
}  // namespace google
...
class TrafficSplit : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:google.appengine.v1.TrafficSplit) */ {
 ...
 private:
  ...
  ::google::protobuf::internal::InternalMetadataWithArena _internal_metadata_;
  public:
  class TrafficSplit_AllocationsEntry : public ::google::protobuf::internal::MapEntry<TrafficSplit_AllocationsEntry, 
      ::std::string, double,
      ::google::protobuf::internal::WireFormatLite::TYPE_STRING,
      ::google::protobuf::internal::WireFormatLite::TYPE_DOUBLE,
      0 > {
  public:
    typedef ::google::protobuf::internal::MapEntry<TrafficSplit_AllocationsEntry, 
      ::std::string, double,
      ::google::protobuf::internal::WireFormatLite::TYPE_STRING,
      ::google::protobuf::internal::WireFormatLite::TYPE_DOUBLE,
      0 > SuperType;
    TrafficSplit_AllocationsEntry();
    TrafficSplit_AllocationsEntry(::google::protobuf::Arena* arena);
    void MergeFrom(const ::google::protobuf::Message& other) PROTOBUF_FINAL;
    void MergeFrom(const TrafficSplit_AllocationsEntry& other);
    static const Message* internal_default_instance() { return reinterpret_cast<const Message*>(&_TrafficSplit_AllocationsEntry_default_instance_); }
