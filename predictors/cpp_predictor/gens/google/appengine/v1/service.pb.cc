...
class TrafficSplit_AllocationsEntryDefaultTypeInternal {
public:
 ::google::protobuf::internal::ExplicitlyConstructed<TrafficSplit::TrafficSplit_AllocationsEntry>
     _instance;
...
file_level_metadata[1].reflection = TrafficSplit::TrafficSplit_AllocationsEntry::CreateReflection(file_level_metadata[1].descriptor, _TrafficSplit_AllocationsEntry_default_instance_._instance.get_mutable());
}
...
void TableStruct::InitDefaultsImpl() {
  ...
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_Service_default_instance_);_TrafficSplit_AllocationsEntry_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_TrafficSplit_AllocationsEntry_default_instance_);_TrafficSplit_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_TrafficSplit_default_instance_);_Service_default_instance_._instance.get_mutable()->split_ = const_cast< ::google::appengine::v1::TrafficSplit*>(
      ::google::appengine::v1::TrafficSplit::internal_default_instance());
  _TrafficSplit_AllocationsEntry_default_instance_._instance.get_mutable()->set_default_instance(_TrafficSplit_AllocationsEntry_default_instance_._instance.get_mutable());
  _TrafficSplit_AllocationsEntry_default_instance_._instance.get_mutable()->InitAsDefaultInstance();
}
