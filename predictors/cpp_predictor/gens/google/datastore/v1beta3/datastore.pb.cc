...
void TableStruct::InitDefaultsImpl() {
  ...
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_TransactionOptions_default_instance_);_LookupRequest_default_instance_._instance.get_mutable()->read_options_ = const_cast< ::google::datastore::v1beta3::ReadOptions*>(
      ::google::datastore::v1beta3::ReadOptions::internal_default_instance());
  _RunQueryRequest_default_instance_._instance.get_mutable()->partition_id_ = const_cast< ::google::datastore::v1beta3::PartitionId*>(
      ::google::datastore::v1beta3::PartitionId::internal_default_instance());
  _RunQueryRequest_default_instance_._instance.get_mutable()->read_options_ = const_cast< ::google::datastore::v1beta3::ReadOptions*>(
      ::google::datastore::v1beta3::ReadOptions::internal_default_instance());
  ...
  _RunQueryResponse_default_instance_._instance.get_mutable()->batch_ = const_cast< ::google::datastore::v1beta3::QueryResultBatch*>(
      ::google::datastore::v1beta3::QueryResultBatch::internal_default_instance());
  _RunQueryResponse_default_instance_._instance.get_mutable()->query_ = const_cast< ::google::datastore::v1beta3::Query*>(
      ::google::datastore::v1beta3::Query::internal_default_instance());
  _BeginTransactionRequest_default_instance_._instance.get_mutable()->transaction_options_ = const_cast< ::google::datastore::v1beta3::TransactionOptions*>(
  ...
  _MutationResult_default_instance_._instance.get_mutable()->key_ = const_cast< ::google::datastore::v1beta3::Key*>(
      ::google::datastore::v1beta3::Key::internal_default_instance());
