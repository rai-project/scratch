...
class Entity_MetadataEntry;
class Entity_MetadataEntryDefaultTypeInternal;
extern Entity_MetadataEntryDefaultTypeInternal _Entity_MetadataEntry_default_instance_;
class PartOfSpeech;
...
class Entity : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:google.cloud.language.v1beta2.Entity) */ {
 ...
 private:
  ...
  ::google::protobuf::internal::InternalMetadataWithArena _internal_metadata_;
  public:
  class Entity_MetadataEntry : public ::google::protobuf::internal::MapEntry<Entity_MetadataEntry, 
      ::std::string, ::std::string,
      ::google::protobuf::internal::WireFormatLite::TYPE_STRING,
      ::google::protobuf::internal::WireFormatLite::TYPE_STRING,
      0 > {
  public:
    typedef ::google::protobuf::internal::MapEntry<Entity_MetadataEntry, 
      ::std::string, ::std::string,
      ::google::protobuf::internal::WireFormatLite::TYPE_STRING,
      ::google::protobuf::internal::WireFormatLite::TYPE_STRING,
      0 > SuperType;
    Entity_MetadataEntry();
    Entity_MetadataEntry(::google::protobuf::Arena* arena);
    void MergeFrom(const ::google::protobuf::Message& other) PROTOBUF_FINAL;
    void MergeFrom(const Entity_MetadataEntry& other);
    static const Message* internal_default_instance() { return reinterpret_cast<const Message*>(&_Entity_MetadataEntry_default_instance_); }
