...
inline void LabelFrame::clear_time_offset() {
...
inline void ExplicitContentFrame::clear_time_offset() {
  if (GetArenaNoVirtual() == NULL && time_offset_ != NULL) delete time_offset_;
  time_offset_ = NULL;
}
...
inline void FaceFrame::clear_time_offset() {
  if (GetArenaNoVirtual() == NULL && time_offset_ != NULL) delete time_offset_;
  time_offset_ = NULL;
}
...
inline void VideoAnnotationResults::clear_error() {
...
inline void VideoAnnotationProgress::clear_start_time() {
...
inline void VideoAnnotationProgress::clear_update_time() {
