...
const ::google::protobuf::uint32 TableStruct::offsets[] GOOGLE_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
  ...
  offsetof(CloudFunctionDefaultTypeInternal, source_archive_url_),
  offsetof(CloudFunctionDefaultTypeInternal, source_repository_),
  offsetof(CloudFunctionDefaultTypeInternal, https_trigger_),
  offsetof(CloudFunctionDefaultTypeInternal, event_trigger_),
  ...
  offsetof(SourceRepositoryDefaultTypeInternal, branch_),
  offsetof(SourceRepositoryDefaultTypeInternal, tag_),
  offsetof(SourceRepositoryDefaultTypeInternal, revision_),
...
void TableStruct::InitDefaultsImpl() {
  ...
  _CloudFunction_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_CloudFunction_default_instance_);_HTTPSTrigger_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_HTTPSTrigger_default_instance_);_EventTrigger_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_EventTrigger_default_instance_);_SourceRepository_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_SourceRepository_default_instance_);_CreateFunctionRequest_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_CreateFunctionRequest_default_instance_);_UpdateFunctionRequest_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_UpdateFunctionRequest_default_instance_);_GetFunctionRequest_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_GetFunctionRequest_default_instance_);_ListFunctionsRequest_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_ListFunctionsRequest_default_instance_);_ListFunctionsResponse_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_ListFunctionsResponse_default_instance_);_DeleteFunctionRequest_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_DeleteFunctionRequest_default_instance_);_CallFunctionRequest_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_CallFunctionRequest_default_instance_);_CallFunctionResponse_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_CallFunctionResponse_default_instance_);_CloudFunction_default_instance_.source_archive_url_.UnsafeSetDefault(
  ...
  _CloudFunction_default_instance_._instance.get_mutable()->timeout_ = const_cast< ::google::protobuf::Duration*>(
      ::google::protobuf::Duration::internal_default_instance());
  _CloudFunction_default_instance_._instance.get_mutable()->update_time_ = const_cast< ::google::protobuf::Timestamp*>(
  ...
  _SourceRepository_default_instance_.revision_.UnsafeSetDefault(
      &::google::protobuf::internal::GetEmptyStringAlreadyInited());
  _CreateFunctionRequest_default_instance_._instance.get_mutable()->function_ = const_cast< ::google::cloud::functions::v1beta2::CloudFunction*>(
      ::google::cloud::functions::v1beta2::CloudFunction::internal_default_instance());
  _UpdateFunctionRequest_default_instance_._instance.get_mutable()->function_ = const_cast< ::google::cloud::functions::v1beta2::CloudFunction*>(
      ::google::cloud::functions::v1beta2::CloudFunction::internal_default_instance());
}
