...
void TableStruct::InitDefaultsImpl() {
  ...
  _OperationMetadataV1Beta2_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_OperationMetadataV1Beta2_default_instance_);_OperationMetadataV1Beta2_default_instance_._instance.get_mutable()->request_ = const_cast< ::google::protobuf::Any*>(
