...
void TableStruct::InitDefaultsImpl() {
  ...
  _ClusterOperationStatus_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_ClusterOperationStatus_default_instance_);_ClusterOperationMetadata_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_ClusterOperationMetadata_default_instance_);_ClusterOperationStatus_default_instance_._instance.get_mutable()->state_start_time_ = const_cast< ::google::protobuf::Timestamp*>(
      ::google::protobuf::Timestamp::internal_default_instance());
  _ClusterOperationMetadata_default_instance_._instance.get_mutable()->status_ = const_cast< ::google::cloud::dataproc::v1::ClusterOperationStatus*>(
