...
void TableStruct::InitDefaultsImpl() {
  ...
  _OperationMetadata_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_OperationMetadata_default_instance_);_OperationMetadata_default_instance_._instance.get_mutable()->create_time_ = const_cast< ::google::protobuf::Timestamp*>(
  ...
  _OperationMetadata_default_instance_._instance.get_mutable()->end_time_ = const_cast< ::google::protobuf::Timestamp*>(
      ::google::protobuf::Timestamp::internal_default_instance());
  _OperationMetadata_default_instance_._instance.get_mutable()->version_ = const_cast< ::google::cloud::ml::v1beta1::Version*>(
