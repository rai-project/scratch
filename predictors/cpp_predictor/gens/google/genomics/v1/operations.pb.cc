...
public:
 ::google::protobuf::internal::ExplicitlyConstructed<OperationMetadata::OperationMetadata_LabelsEntry>
     _instance;
...
file_level_metadata[0].reflection = OperationMetadata::OperationMetadata_LabelsEntry::CreateReflection(file_level_metadata[0].descriptor, _OperationMetadata_LabelsEntry_default_instance_._instance.get_mutable());
}
...
void TableStruct::InitDefaultsImpl() {
  ...
  _OperationMetadata_LabelsEntry_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_OperationMetadata_LabelsEntry_default_instance_);_OperationMetadata_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_OperationMetadata_default_instance_);_OperationEvent_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_OperationEvent_default_instance_);_OperationMetadata_LabelsEntry_default_instance_._instance.get_mutable()->set_default_instance(_OperationMetadata_LabelsEntry_default_instance_._instance.get_mutable());
  _OperationMetadata_LabelsEntry_default_instance_._instance.get_mutable()->InitAsDefaultInstance();
  _OperationMetadata_default_instance_._instance.get_mutable()->create_time_ = const_cast< ::google::protobuf::Timestamp*>(
      ::google::protobuf::Timestamp::internal_default_instance());
  _OperationMetadata_default_instance_._instance.get_mutable()->start_time_ = const_cast< ::google::protobuf::Timestamp*>(
      ::google::protobuf::Timestamp::internal_default_instance());
  _OperationMetadata_default_instance_._instance.get_mutable()->end_time_ = const_cast< ::google::protobuf::Timestamp*>(
      ::google::protobuf::Timestamp::internal_default_instance());
  _OperationMetadata_default_instance_._instance.get_mutable()->request_ = const_cast< ::google::protobuf::Any*>(
      ::google::protobuf::Any::internal_default_instance());
  _OperationMetadata_default_instance_._instance.get_mutable()->runtime_metadata_ = const_cast< ::google::protobuf::Any*>(
      ::google::protobuf::Any::internal_default_instance());
  _OperationEvent_default_instance_._instance.get_mutable()->start_time_ = const_cast< ::google::protobuf::Timestamp*>(
      ::google::protobuf::Timestamp::internal_default_instance());
  _OperationEvent_default_instance_._instance.get_mutable()->end_time_ = const_cast< ::google::protobuf::Timestamp*>(
      ::google::protobuf::Timestamp::internal_default_instance());
}
...
#if LANG_CXX11
void OperationMetadata::set_project_id(::std::string&& value) {
...
#if LANG_CXX11
void OperationMetadata::set_client_id(::std::string&& value) {
...
#if LANG_CXX11
void OperationEvent::set_description(::std::string&& value) {
