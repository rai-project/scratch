...
void TableStruct::InitDefaultsImpl() {
  ...
  _Color_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_Color_default_instance_);_Color_default_instance_._instance.get_mutable()->alpha_ = const_cast< ::google::protobuf::FloatValue*>(
