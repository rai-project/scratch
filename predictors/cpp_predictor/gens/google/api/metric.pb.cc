...
public:
 ::google::protobuf::internal::ExplicitlyConstructed<Metric::Metric_LabelsEntry>
     _instance;
} _Metric_LabelsEntry_default_instance_;
...
static ::google::protobuf::Message const * const file_default_instances[] = {
  ...
  reinterpret_cast<const ::google::protobuf::Message*>(&_Metric_LabelsEntry_default_instance_),
...
file_level_metadata[1].reflection = Metric::Metric_LabelsEntry::CreateReflection(file_level_metadata[1].descriptor, _Metric_LabelsEntry_default_instance_._instance.get_mutable());
}
...
void TableStruct::InitDefaultsImpl() {
  ...
  _MetricDescriptor_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_MetricDescriptor_default_instance_);_Metric_LabelsEntry_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_Metric_LabelsEntry_default_instance_);_Metric_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_Metric_default_instance_);_Metric_LabelsEntry_default_instance_._instance.get_mutable()->set_default_instance(_Metric_LabelsEntry_default_instance_._instance.get_mutable());
  _Metric_LabelsEntry_default_instance_._instance.get_mutable()->InitAsDefaultInstance();
}
...
Metric::Metric_LabelsEntry::Metric_LabelsEntry() {}
Metric::Metric_LabelsEntry::Metric_LabelsEntry(::google::protobuf::Arena* arena) : SuperType(arena) {}
::google::protobuf::Metadata Metric::Metric_LabelsEntry::GetMetadata() const {
  protobuf_google_2fapi_2fmetric_2eproto::protobuf_AssignDescriptorsOnce();
  return protobuf_google_2fapi_2fmetric_2eproto::file_level_metadata[1];
}
void Metric::Metric_LabelsEntry::MergeFrom(
    const ::google::protobuf::Message& other) {
  ::google::protobuf::Message::MergeFrom(other);
}
void Metric::Metric_LabelsEntry::MergeFrom(const Metric_LabelsEntry& other) {
