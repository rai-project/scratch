...
const ::google::protobuf::uint32 TableStruct::offsets[] GOOGLE_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
  ...
  ~0u,  // no _weak_field_map_
  offsetof(Distribution_BucketOptionsDefaultTypeInternal, linear_buckets_),
  offsetof(Distribution_BucketOptionsDefaultTypeInternal, exponential_buckets_),
  offsetof(Distribution_BucketOptionsDefaultTypeInternal, explicit_buckets_),
...
static const ::google::protobuf::internal::MigrationSchema schemas[] GOOGLE_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
  ...
  { 7, -1, sizeof(Distribution_BucketOptions_Linear)},
  { 15, -1, sizeof(Distribution_BucketOptions_Exponential)},
  { 23, -1, sizeof(Distribution_BucketOptions_Explicit)},
  { 29, -1, sizeof(Distribution_BucketOptions)},
  { 38, -1, sizeof(Distribution)},
};
...
void TableStruct::InitDefaultsImpl() {
  ...
  _Distribution_Range_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_Distribution_Range_default_instance_);_Distribution_BucketOptions_Linear_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_Distribution_BucketOptions_Linear_default_instance_);_Distribution_BucketOptions_Exponential_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_Distribution_BucketOptions_Exponential_default_instance_);_Distribution_BucketOptions_Explicit_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_Distribution_BucketOptions_Explicit_default_instance_);_Distribution_BucketOptions_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_Distribution_BucketOptions_default_instance_);_Distribution_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_Distribution_default_instance_);_Distribution_BucketOptions_default_instance_.linear_buckets_ = const_cast< ::google::api::Distribution_BucketOptions_Linear*>(
  ...
  _Distribution_default_instance_._instance.get_mutable()->range_ = const_cast< ::google::api::Distribution_Range*>(
      ::google::api::Distribution_Range::internal_default_instance());
  _Distribution_default_instance_._instance.get_mutable()->bucket_options_ = const_cast< ::google::api::Distribution_BucketOptions*>(
