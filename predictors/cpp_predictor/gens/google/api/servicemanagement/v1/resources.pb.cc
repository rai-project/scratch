...
class Rollout_TrafficPercentStrategy_PercentagesEntryDefaultTypeInternal {
public:
 ::google::protobuf::internal::ExplicitlyConstructed<Rollout_TrafficPercentStrategy::Rollout_TrafficPercentStrategy_PercentagesEntry>
     _instance;
} _Rollout_TrafficPercentStrategy_PercentagesEntry_default_instance_;
...
const ::google::protobuf::uint32 TableStruct::offsets[] GOOGLE_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
  ...
  offsetof(RolloutDefaultTypeInternal, traffic_percent_strategy_),
  offsetof(RolloutDefaultTypeInternal, delete_service_strategy_),
...
static const ::google::protobuf::internal::MigrationSchema schemas[] GOOGLE_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
  ...
  { 7, -1, sizeof(OperationMetadata_Step)},
  { 14, -1, sizeof(OperationMetadata)},
  { 23, -1, sizeof(Diagnostic)},
  { 31, -1, sizeof(ConfigSource)},
  { 38, -1, sizeof(ConfigFile)},
  { 46, -1, sizeof(ConfigRef)},
  { 52, -1, sizeof(ChangeReport)},
  { 58, -1, sizeof(Rollout_TrafficPercentStrategy)},
  { 64, -1, sizeof(Rollout_DeleteServiceStrategy)},
  { 69, -1, sizeof(Rollout)},
};
...
static ::google::protobuf::Message const * const file_default_instances[] = {
  ...
  reinterpret_cast<const ::google::protobuf::Message*>(&_Rollout_TrafficPercentStrategy_PercentagesEntry_default_instance_),
...
file_level_metadata[8].reflection = Rollout_TrafficPercentStrategy::Rollout_TrafficPercentStrategy_PercentagesEntry::CreateReflection(file_level_metadata[8].descriptor, _Rollout_TrafficPercentStrategy_PercentagesEntry_default_instance_._instance.get_mutable());
}
...
void TableStruct::InitDefaultsImpl() {
  ...
  _ManagedService_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_ManagedService_default_instance_);_OperationMetadata_Step_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_OperationMetadata_Step_default_instance_);_OperationMetadata_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_OperationMetadata_default_instance_);_Diagnostic_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_Diagnostic_default_instance_);_ConfigSource_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_ConfigSource_default_instance_);_ConfigFile_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_ConfigFile_default_instance_);_ConfigRef_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_ConfigRef_default_instance_);_ChangeReport_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_ChangeReport_default_instance_);_Rollout_TrafficPercentStrategy_PercentagesEntry_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_Rollout_TrafficPercentStrategy_PercentagesEntry_default_instance_);_Rollout_TrafficPercentStrategy_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_Rollout_TrafficPercentStrategy_default_instance_);_Rollout_DeleteServiceStrategy_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_Rollout_DeleteServiceStrategy_default_instance_);_Rollout_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_Rollout_default_instance_);_OperationMetadata_default_instance_._instance.get_mutable()->start_time_ = const_cast< ::google::protobuf::Timestamp*>(
      ::google::protobuf::Timestamp::internal_default_instance());
  _Rollout_TrafficPercentStrategy_PercentagesEntry_default_instance_._instance.get_mutable()->set_default_instance(_Rollout_TrafficPercentStrategy_PercentagesEntry_default_instance_._instance.get_mutable());
  _Rollout_TrafficPercentStrategy_PercentagesEntry_default_instance_._instance.get_mutable()->InitAsDefaultInstance();
  _Rollout_default_instance_._instance.get_mutable()->create_time_ = const_cast< ::google::protobuf::Timestamp*>(
      ::google::protobuf::Timestamp::internal_default_instance());
...
#if LANG_CXX11
void OperationMetadata::set_resource_names(int index, ::std::string&& value) {
  // @@protoc_insertion_point(field_set:google.api.servicemanagement.v1.OperationMetadata.resource_names)
...
#if LANG_CXX11
void OperationMetadata::add_resource_names(::std::string&& value) {
...
Rollout_TrafficPercentStrategy::Rollout_TrafficPercentStrategy_PercentagesEntry::Rollout_TrafficPercentStrategy_PercentagesEntry() {}
Rollout_TrafficPercentStrategy::Rollout_TrafficPercentStrategy_PercentagesEntry::Rollout_TrafficPercentStrategy_PercentagesEntry(::google::protobuf::Arena* arena) : SuperType(arena) {}
::google::protobuf::Metadata Rollout_TrafficPercentStrategy::Rollout_TrafficPercentStrategy_PercentagesEntry::GetMetadata() const {
  protobuf_google_2fapi_2fservicemanagement_2fv1_2fresources_2eproto::protobuf_AssignDescriptorsOnce();
  return protobuf_google_2fapi_2fservicemanagement_2fv1_2fresources_2eproto::file_level_metadata[8];
}
void Rollout_TrafficPercentStrategy::Rollout_TrafficPercentStrategy_PercentagesEntry::MergeFrom(
    const ::google::protobuf::Message& other) {
  ::google::protobuf::Message::MergeFrom(other);
}
void Rollout_TrafficPercentStrategy::Rollout_TrafficPercentStrategy_PercentagesEntry::MergeFrom(const Rollout_TrafficPercentStrategy_PercentagesEntry& other) {
