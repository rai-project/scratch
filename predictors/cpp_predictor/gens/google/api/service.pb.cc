...
void TableStruct::InitDefaultsImpl() {
  ...
  _Service_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_Service_default_instance_);_Service_default_instance_._instance.get_mutable()->config_version_ = const_cast< ::google::protobuf::UInt32Value*>(
      ::google::protobuf::UInt32Value::internal_default_instance());
  _Service_default_instance_._instance.get_mutable()->documentation_ = const_cast< ::google::api::Documentation*>(
      ::google::api::Documentation::internal_default_instance());
  _Service_default_instance_._instance.get_mutable()->backend_ = const_cast< ::google::api::Backend*>(
      ::google::api::Backend::internal_default_instance());
  _Service_default_instance_._instance.get_mutable()->http_ = const_cast< ::google::api::Http*>(
      ::google::api::Http::internal_default_instance());
  _Service_default_instance_._instance.get_mutable()->quota_ = const_cast< ::google::api::Quota*>(
      ::google::api::Quota::internal_default_instance());
  _Service_default_instance_._instance.get_mutable()->authentication_ = const_cast< ::google::api::Authentication*>(
      ::google::api::Authentication::internal_default_instance());
  _Service_default_instance_._instance.get_mutable()->context_ = const_cast< ::google::api::Context*>(
      ::google::api::Context::internal_default_instance());
  _Service_default_instance_._instance.get_mutable()->usage_ = const_cast< ::google::api::Usage*>(
      ::google::api::Usage::internal_default_instance());
  _Service_default_instance_._instance.get_mutable()->control_ = const_cast< ::google::api::Control*>(
      ::google::api::Control::internal_default_instance());
  _Service_default_instance_._instance.get_mutable()->logging_ = const_cast< ::google::api::Logging*>(
      ::google::api::Logging::internal_default_instance());
  _Service_default_instance_._instance.get_mutable()->monitoring_ = const_cast< ::google::api::Monitoring*>(
      ::google::api::Monitoring::internal_default_instance());
  _Service_default_instance_._instance.get_mutable()->system_parameters_ = const_cast< ::google::api::SystemParameters*>(
      ::google::api::SystemParameters::internal_default_instance());
  _Service_default_instance_._instance.get_mutable()->source_info_ = const_cast< ::google::api::SourceInfo*>(
      ::google::api::SourceInfo::internal_default_instance());
  _Service_default_instance_._instance.get_mutable()->experimental_ = const_cast< ::google::api::Experimental*>(
