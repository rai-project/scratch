...
namespace v1 {
class MetricValue_LabelsEntryDefaultTypeInternal {
public:
 ::google::protobuf::internal::ExplicitlyConstructed<MetricValue::MetricValue_LabelsEntry>
     _instance;
} _MetricValue_LabelsEntry_default_instance_;
...
const ::google::protobuf::uint32 TableStruct::offsets[] GOOGLE_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
  ...
  offsetof(MetricValueDefaultTypeInternal, bool_value_),
  offsetof(MetricValueDefaultTypeInternal, int64_value_),
  offsetof(MetricValueDefaultTypeInternal, double_value_),
  offsetof(MetricValueDefaultTypeInternal, string_value_),
  offsetof(MetricValueDefaultTypeInternal, distribution_value_),
...
static const ::google::protobuf::internal::MigrationSchema schemas[] GOOGLE_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
  ...
  { 14, -1, sizeof(MetricValueSet)},
};

static ::google::protobuf::Message const * const file_default_instances[] = {
  reinterpret_cast<const ::google::protobuf::Message*>(&_MetricValue_LabelsEntry_default_instance_),
...
file_level_metadata[0].reflection = MetricValue::MetricValue_LabelsEntry::CreateReflection(file_level_metadata[0].descriptor, _MetricValue_LabelsEntry_default_instance_._instance.get_mutable());
}
...
void TableStruct::InitDefaultsImpl() {
  ...
  _MetricValue_LabelsEntry_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_MetricValue_LabelsEntry_default_instance_);_MetricValue_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_MetricValue_default_instance_);_MetricValueSet_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_MetricValueSet_default_instance_);_MetricValue_LabelsEntry_default_instance_._instance.get_mutable()->set_default_instance(_MetricValue_LabelsEntry_default_instance_._instance.get_mutable());
  _MetricValue_LabelsEntry_default_instance_._instance.get_mutable()->InitAsDefaultInstance();
  _MetricValue_default_instance_._instance.get_mutable()->start_time_ = const_cast< ::google::protobuf::Timestamp*>(
      ::google::protobuf::Timestamp::internal_default_instance());
  _MetricValue_default_instance_._instance.get_mutable()->end_time_ = const_cast< ::google::protobuf::Timestamp*>(
      ::google::protobuf::Timestamp::internal_default_instance());
...
MetricValue::MetricValue_LabelsEntry::MetricValue_LabelsEntry() {}
MetricValue::MetricValue_LabelsEntry::MetricValue_LabelsEntry(::google::protobuf::Arena* arena) : SuperType(arena) {}
::google::protobuf::Metadata MetricValue::MetricValue_LabelsEntry::GetMetadata() const {
...
void MetricValue::MetricValue_LabelsEntry::MergeFrom(
    const ::google::protobuf::Message& other) {
  ::google::protobuf::Message::MergeFrom(other);
}
void MetricValue::MetricValue_LabelsEntry::MergeFrom(const MetricValue_LabelsEntry& other) {
...
#if LANG_CXX11
void MetricValue::set_string_value(::std::string&& value) {
  // @@protoc_insertion_point(field_set:google.api.servicecontrol.v1.MetricValue.string_value)
  if (!has_string_value()) {
    clear_value();
    set_has_string_value();
...
#if LANG_CXX11
void MetricValueSet::set_metric_name(::std::string&& value) {
