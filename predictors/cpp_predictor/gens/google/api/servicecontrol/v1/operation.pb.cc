...
public:
 ::google::protobuf::internal::ExplicitlyConstructed<Operation::Operation_LabelsEntry>
     _instance;
} _Operation_LabelsEntry_default_instance_;
...
static ::google::protobuf::Message const * const file_default_instances[] = {
  reinterpret_cast<const ::google::protobuf::Message*>(&_Operation_LabelsEntry_default_instance_),
...
file_level_metadata[0].reflection = Operation::Operation_LabelsEntry::CreateReflection(file_level_metadata[0].descriptor, _Operation_LabelsEntry_default_instance_._instance.get_mutable());
}
...
void TableStruct::InitDefaultsImpl() {
  ...
  _Operation_LabelsEntry_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_Operation_LabelsEntry_default_instance_);_Operation_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_Operation_default_instance_);_Operation_LabelsEntry_default_instance_._instance.get_mutable()->set_default_instance(_Operation_LabelsEntry_default_instance_._instance.get_mutable());
  _Operation_LabelsEntry_default_instance_._instance.get_mutable()->InitAsDefaultInstance();
  _Operation_default_instance_._instance.get_mutable()->start_time_ = const_cast< ::google::protobuf::Timestamp*>(
      ::google::protobuf::Timestamp::internal_default_instance());
  _Operation_default_instance_._instance.get_mutable()->end_time_ = const_cast< ::google::protobuf::Timestamp*>(
      ::google::protobuf::Timestamp::internal_default_instance());
}
...
Operation::Operation_LabelsEntry::Operation_LabelsEntry() {}
Operation::Operation_LabelsEntry::Operation_LabelsEntry(::google::protobuf::Arena* arena) : SuperType(arena) {}
::google::protobuf::Metadata Operation::Operation_LabelsEntry::GetMetadata() const {
  protobuf_google_2fapi_2fservicecontrol_2fv1_2foperation_2eproto::protobuf_AssignDescriptorsOnce();
  return protobuf_google_2fapi_2fservicecontrol_2fv1_2foperation_2eproto::file_level_metadata[0];
}
void Operation::Operation_LabelsEntry::MergeFrom(
    const ::google::protobuf::Message& other) {
  ::google::protobuf::Message::MergeFrom(other);
}
void Operation::Operation_LabelsEntry::MergeFrom(const Operation_LabelsEntry& other) {
...
#if LANG_CXX11
void Operation::set_operation_id(::std::string&& value) {
...
#if LANG_CXX11
void Operation::set_operation_name(::std::string&& value) {
...
#if LANG_CXX11
void Operation::set_consumer_id(::std::string&& value) {
