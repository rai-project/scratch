...
class MetricValue_LabelsEntry;
class MetricValue_LabelsEntryDefaultTypeInternal;
extern MetricValue_LabelsEntryDefaultTypeInternal _MetricValue_LabelsEntry_default_instance_;
}  // namespace v1
}  // namespace servicecontrol
}  // namespace api
}  // namespace google
...
class MetricValue : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:google.api.servicecontrol.v1.MetricValue) */ {
 ...
 private:
  ...
  public:
  class MetricValue_LabelsEntry : public ::google::protobuf::internal::MapEntry<MetricValue_LabelsEntry, 
      ::std::string, ::std::string,
      ::google::protobuf::internal::WireFormatLite::TYPE_STRING,
      ::google::protobuf::internal::WireFormatLite::TYPE_STRING,
      0 > {
  public:
    typedef ::google::protobuf::internal::MapEntry<MetricValue_LabelsEntry, 
      ::std::string, ::std::string,
      ::google::protobuf::internal::WireFormatLite::TYPE_STRING,
      ::google::protobuf::internal::WireFormatLite::TYPE_STRING,
      0 > SuperType;
    MetricValue_LabelsEntry();
    MetricValue_LabelsEntry(::google::protobuf::Arena* arena);
    void MergeFrom(const ::google::protobuf::Message& other) PROTOBUF_FINAL;
    void MergeFrom(const MetricValue_LabelsEntry& other);
    static const Message* internal_default_instance() { return reinterpret_cast<const Message*>(&_MetricValue_LabelsEntry_default_instance_); }
