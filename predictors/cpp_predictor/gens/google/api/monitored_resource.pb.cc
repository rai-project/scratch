...
class MonitoredResource_LabelsEntryDefaultTypeInternal {
public:
 ::google::protobuf::internal::ExplicitlyConstructed<MonitoredResource::MonitoredResource_LabelsEntry>
     _instance;
...
file_level_metadata[1].reflection = MonitoredResource::MonitoredResource_LabelsEntry::CreateReflection(file_level_metadata[1].descriptor, _MonitoredResource_LabelsEntry_default_instance_._instance.get_mutable());
}
...
void TableStruct::InitDefaultsImpl() {
  ...
  _MonitoredResourceDescriptor_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_MonitoredResourceDescriptor_default_instance_);_MonitoredResource_LabelsEntry_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_MonitoredResource_LabelsEntry_default_instance_);_MonitoredResource_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_MonitoredResource_default_instance_);_MonitoredResource_LabelsEntry_default_instance_._instance.get_mutable()->set_default_instance(_MonitoredResource_LabelsEntry_default_instance_._instance.get_mutable());
  _MonitoredResource_LabelsEntry_default_instance_._instance.get_mutable()->InitAsDefaultInstance();
}
...
#if LANG_CXX11
void MonitoredResourceDescriptor::set_name(::std::string&& value) {
...
#if LANG_CXX11
void MonitoredResourceDescriptor::set_type(::std::string&& value) {
...
#if LANG_CXX11
void MonitoredResourceDescriptor::set_display_name(::std::string&& value) {
...
#if LANG_CXX11
void MonitoredResourceDescriptor::set_description(::std::string&& value) {
...
#if LANG_CXX11
void MonitoredResource::set_type(::std::string&& value) {
