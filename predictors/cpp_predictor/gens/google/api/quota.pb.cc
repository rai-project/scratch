...
class MetricRule_MetricCostsEntryDefaultTypeInternal {
public:
 ::google::protobuf::internal::ExplicitlyConstructed<MetricRule::MetricRule_MetricCostsEntry>
     _instance;
...
class QuotaLimit_ValuesEntryDefaultTypeInternal {
public:
 ::google::protobuf::internal::ExplicitlyConstructed<QuotaLimit::QuotaLimit_ValuesEntry>
     _instance;
...
file_level_metadata[1].reflection = MetricRule::MetricRule_MetricCostsEntry::CreateReflection(file_level_metadata[1].descriptor, _MetricRule_MetricCostsEntry_default_instance_._instance.get_mutable());
file_level_metadata[3].reflection = QuotaLimit::QuotaLimit_ValuesEntry::CreateReflection(file_level_metadata[3].descriptor, _QuotaLimit_ValuesEntry_default_instance_._instance.get_mutable());
}
...
void TableStruct::InitDefaultsImpl() {
  ...
  _Quota_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_Quota_default_instance_);_MetricRule_MetricCostsEntry_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_MetricRule_MetricCostsEntry_default_instance_);_MetricRule_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_MetricRule_default_instance_);_QuotaLimit_ValuesEntry_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_QuotaLimit_ValuesEntry_default_instance_);_QuotaLimit_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_QuotaLimit_default_instance_);_MetricRule_MetricCostsEntry_default_instance_._instance.get_mutable()->set_default_instance(_MetricRule_MetricCostsEntry_default_instance_._instance.get_mutable());
  _MetricRule_MetricCostsEntry_default_instance_._instance.get_mutable()->InitAsDefaultInstance();
  _QuotaLimit_ValuesEntry_default_instance_._instance.get_mutable()->set_default_instance(_QuotaLimit_ValuesEntry_default_instance_._instance.get_mutable());
  _QuotaLimit_ValuesEntry_default_instance_._instance.get_mutable()->InitAsDefaultInstance();
}
