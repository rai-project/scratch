...
class MonitoredResource_LabelsEntry;
class MonitoredResource_LabelsEntryDefaultTypeInternal;
extern MonitoredResource_LabelsEntryDefaultTypeInternal _MonitoredResource_LabelsEntry_default_instance_;
}  // namespace api
}  // namespace google
...
class MonitoredResource : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:google.api.MonitoredResource) */ {
 ...
 private:
  ...
  typedef void DestructorSkippable_;
  public:
  class MonitoredResource_LabelsEntry : public ::google::protobuf::internal::MapEntry<MonitoredResource_LabelsEntry, 
      ::std::string, ::std::string,
      ::google::protobuf::internal::WireFormatLite::TYPE_STRING,
      ::google::protobuf::internal::WireFormatLite::TYPE_STRING,
      0 > {
  public:
    typedef ::google::protobuf::internal::MapEntry<MonitoredResource_LabelsEntry, 
      ::std::string, ::std::string,
      ::google::protobuf::internal::WireFormatLite::TYPE_STRING,
      ::google::protobuf::internal::WireFormatLite::TYPE_STRING,
      0 > SuperType;
    MonitoredResource_LabelsEntry();
    MonitoredResource_LabelsEntry(::google::protobuf::Arena* arena);
    void MergeFrom(const ::google::protobuf::Message& other) PROTOBUF_FINAL;
    void MergeFrom(const MonitoredResource_LabelsEntry& other);
    static const Message* internal_default_instance() { return reinterpret_cast<const Message*>(&_MonitoredResource_LabelsEntry_default_instance_); }
