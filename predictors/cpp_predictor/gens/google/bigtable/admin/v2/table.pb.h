...
class Table : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:google.bigtable.admin.v2.Table) */ {
 ...
 private:
  ...
  public:
  class Table_ColumnFamiliesEntry : public ::google::protobuf::internal::MapEntry<Table_ColumnFamiliesEntry, 
      ::std::string, ::google::bigtable::admin::v2::ColumnFamily,
      ::google::protobuf::internal::WireFormatLite::TYPE_STRING,
      ::google::protobuf::internal::WireFormatLite::TYPE_MESSAGE,
      0 > {
  public:
    typedef ::google::protobuf::internal::MapEntry<Table_ColumnFamiliesEntry, 
      ::std::string, ::google::bigtable::admin::v2::ColumnFamily,
      ::google::protobuf::internal::WireFormatLite::TYPE_STRING,
      ::google::protobuf::internal::WireFormatLite::TYPE_MESSAGE,
      0 > SuperType;
    Table_ColumnFamiliesEntry();
    Table_ColumnFamiliesEntry(::google::protobuf::Arena* arena);
    void MergeFrom(const ::google::protobuf::Message& other) PROTOBUF_FINAL;
    void MergeFrom(const Table_ColumnFamiliesEntry& other);
    static const Message* internal_default_instance() { return reinterpret_cast<const Message*>(&_Table_ColumnFamiliesEntry_default_instance_); }
