...
void TableStruct::InitDefaultsImpl() {
  ...
  _GetGroupRequest_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_GetGroupRequest_default_instance_);_UpdateGroupRequest_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_UpdateGroupRequest_default_instance_);_UpdateGroupRequest_default_instance_._instance.get_mutable()->group_ = const_cast< ::google::devtools::clouderrorreporting::v1beta1::ErrorGroup*>(
