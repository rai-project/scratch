...
void TableStruct::InitDefaultsImpl() {
  ...
  _ReportErrorEventRequest_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_ReportErrorEventRequest_default_instance_);_ReportErrorEventResponse_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_ReportErrorEventResponse_default_instance_);_ReportedErrorEvent_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_ReportedErrorEvent_default_instance_);_ReportErrorEventRequest_default_instance_._instance.get_mutable()->event_ = const_cast< ::google::devtools::clouderrorreporting::v1beta1::ReportedErrorEvent*>(
      ::google::devtools::clouderrorreporting::v1beta1::ReportedErrorEvent::internal_default_instance());
  _ReportedErrorEvent_default_instance_._instance.get_mutable()->event_time_ = const_cast< ::google::protobuf::Timestamp*>(
      ::google::protobuf::Timestamp::internal_default_instance());
  _ReportedErrorEvent_default_instance_._instance.get_mutable()->service_context_ = const_cast< ::google::devtools::clouderrorreporting::v1beta1::ServiceContext*>(
      ::google::devtools::clouderrorreporting::v1beta1::ServiceContext::internal_default_instance());
  _ReportedErrorEvent_default_instance_._instance.get_mutable()->context_ = const_cast< ::google::devtools::clouderrorreporting::v1beta1::ErrorContext*>(
