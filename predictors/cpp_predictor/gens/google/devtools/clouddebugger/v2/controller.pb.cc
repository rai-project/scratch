...
void TableStruct::InitDefaultsImpl() {
  ...
  _RegisterDebuggeeRequest_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_RegisterDebuggeeRequest_default_instance_);_RegisterDebuggeeResponse_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_RegisterDebuggeeResponse_default_instance_);_ListActiveBreakpointsRequest_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_ListActiveBreakpointsRequest_default_instance_);_ListActiveBreakpointsResponse_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_ListActiveBreakpointsResponse_default_instance_);_UpdateActiveBreakpointRequest_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_UpdateActiveBreakpointRequest_default_instance_);_UpdateActiveBreakpointResponse_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_UpdateActiveBreakpointResponse_default_instance_);_RegisterDebuggeeRequest_default_instance_._instance.get_mutable()->debuggee_ = const_cast< ::google::devtools::clouddebugger::v2::Debuggee*>(
      ::google::devtools::clouddebugger::v2::Debuggee::internal_default_instance());
  _RegisterDebuggeeResponse_default_instance_._instance.get_mutable()->debuggee_ = const_cast< ::google::devtools::clouddebugger::v2::Debuggee*>(
      ::google::devtools::clouddebugger::v2::Debuggee::internal_default_instance());
  _UpdateActiveBreakpointRequest_default_instance_._instance.get_mutable()->breakpoint_ = const_cast< ::google::devtools::clouddebugger::v2::Breakpoint*>(
