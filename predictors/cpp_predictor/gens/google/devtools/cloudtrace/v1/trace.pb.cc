...
class TraceSpan_LabelsEntryDefaultTypeInternal {
public:
 ::google::protobuf::internal::ExplicitlyConstructed<TraceSpan::TraceSpan_LabelsEntry>
     _instance;
...
file_level_metadata[2].reflection = TraceSpan::TraceSpan_LabelsEntry::CreateReflection(file_level_metadata[2].descriptor, _TraceSpan_LabelsEntry_default_instance_._instance.get_mutable());
}
...
void TableStruct::InitDefaultsImpl() {
  ...
  _Trace_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_Trace_default_instance_);_Traces_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_Traces_default_instance_);_TraceSpan_LabelsEntry_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_TraceSpan_LabelsEntry_default_instance_);_TraceSpan_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_TraceSpan_default_instance_);_ListTracesRequest_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_ListTracesRequest_default_instance_);_ListTracesResponse_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_ListTracesResponse_default_instance_);_GetTraceRequest_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_GetTraceRequest_default_instance_);_PatchTracesRequest_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_PatchTracesRequest_default_instance_);_TraceSpan_LabelsEntry_default_instance_._instance.get_mutable()->set_default_instance(_TraceSpan_LabelsEntry_default_instance_._instance.get_mutable());
  _TraceSpan_LabelsEntry_default_instance_._instance.get_mutable()->InitAsDefaultInstance();
  _TraceSpan_default_instance_._instance.get_mutable()->start_time_ = const_cast< ::google::protobuf::Timestamp*>(
      ::google::protobuf::Timestamp::internal_default_instance());
  _TraceSpan_default_instance_._instance.get_mutable()->end_time_ = const_cast< ::google::protobuf::Timestamp*>(
      ::google::protobuf::Timestamp::internal_default_instance());
  _ListTracesRequest_default_instance_._instance.get_mutable()->start_time_ = const_cast< ::google::protobuf::Timestamp*>(
      ::google::protobuf::Timestamp::internal_default_instance());
  _ListTracesRequest_default_instance_._instance.get_mutable()->end_time_ = const_cast< ::google::protobuf::Timestamp*>(
      ::google::protobuf::Timestamp::internal_default_instance());
  _PatchTracesRequest_default_instance_._instance.get_mutable()->traces_ = const_cast< ::google::devtools::cloudtrace::v1::Traces*>(
