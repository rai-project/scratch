...
class TraceSpan_LabelsEntry;
class TraceSpan_LabelsEntryDefaultTypeInternal;
extern TraceSpan_LabelsEntryDefaultTypeInternal _TraceSpan_LabelsEntry_default_instance_;
class Traces;
...
class TraceSpan : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:google.devtools.cloudtrace.v1.TraceSpan) */ {
 ...
 private:
  ...
  ::google::protobuf::internal::InternalMetadataWithArena _internal_metadata_;
  public:
  class TraceSpan_LabelsEntry : public ::google::protobuf::internal::MapEntry<TraceSpan_LabelsEntry, 
      ::std::string, ::std::string,
      ::google::protobuf::internal::WireFormatLite::TYPE_STRING,
      ::google::protobuf::internal::WireFormatLite::TYPE_STRING,
      0 > {
  public:
    typedef ::google::protobuf::internal::MapEntry<TraceSpan_LabelsEntry, 
      ::std::string, ::std::string,
      ::google::protobuf::internal::WireFormatLite::TYPE_STRING,
      ::google::protobuf::internal::WireFormatLite::TYPE_STRING,
      0 > SuperType;
    TraceSpan_LabelsEntry();
    TraceSpan_LabelsEntry(::google::protobuf::Arena* arena);
    void MergeFrom(const ::google::protobuf::Message& other) PROTOBUF_FINAL;
    void MergeFrom(const TraceSpan_LabelsEntry& other);
    static const Message* internal_default_instance() { return reinterpret_cast<const Message*>(&_TraceSpan_LabelsEntry_default_instance_); }
