...
static const ::google::protobuf::internal::MigrationSchema schemas[] GOOGLE_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
  ...
  { 9, -1, sizeof(ListMonitoredResourceDescriptorsResponse)},
  { 16, -1, sizeof(GetMonitoredResourceDescriptorRequest)},
  { 22, -1, sizeof(ListMetricDescriptorsRequest)},
  { 31, -1, sizeof(ListMetricDescriptorsResponse)},
  { 38, -1, sizeof(GetMetricDescriptorRequest)},
  { 44, -1, sizeof(CreateMetricDescriptorRequest)},
  { 51, -1, sizeof(DeleteMetricDescriptorRequest)},
  { 57, -1, sizeof(ListTimeSeriesRequest)},
  { 70, -1, sizeof(ListTimeSeriesResponse)},
  { 77, -1, sizeof(CreateTimeSeriesRequest)},
  { 84, -1, sizeof(CreateTimeSeriesError)},
};
...
void TableStruct::InitDefaultsImpl() {
  ...
  _ListMonitoredResourceDescriptorsRequest_default_instance_._instance.DefaultConstruct();
  ...
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_ListMonitoredResourceDescriptorsResponse_default_instance_);_GetMonitoredResourceDescriptorRequest_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_GetMonitoredResourceDescriptorRequest_default_instance_);_ListMetricDescriptorsRequest_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_ListMetricDescriptorsRequest_default_instance_);_ListMetricDescriptorsResponse_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_ListMetricDescriptorsResponse_default_instance_);_GetMetricDescriptorRequest_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_GetMetricDescriptorRequest_default_instance_);_CreateMetricDescriptorRequest_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_CreateMetricDescriptorRequest_default_instance_);_DeleteMetricDescriptorRequest_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_DeleteMetricDescriptorRequest_default_instance_);_ListTimeSeriesRequest_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_ListTimeSeriesRequest_default_instance_);_ListTimeSeriesResponse_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_ListTimeSeriesResponse_default_instance_);_CreateTimeSeriesRequest_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_CreateTimeSeriesRequest_default_instance_);_CreateTimeSeriesError_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_CreateTimeSeriesError_default_instance_);_CreateMetricDescriptorRequest_default_instance_._instance.get_mutable()->metric_descriptor_ = const_cast< ::google::api::MetricDescriptor*>(
      ::google::api::MetricDescriptor::internal_default_instance());
  _ListTimeSeriesRequest_default_instance_._instance.get_mutable()->interval_ = const_cast< ::google::monitoring::v3::TimeInterval*>(
      ::google::monitoring::v3::TimeInterval::internal_default_instance());
  _ListTimeSeriesRequest_default_instance_._instance.get_mutable()->aggregation_ = const_cast< ::google::monitoring::v3::Aggregation*>(
      ::google::monitoring::v3::Aggregation::internal_default_instance());
  _CreateTimeSeriesError_default_instance_._instance.get_mutable()->time_series_ = const_cast< ::google::monitoring::v3::TimeSeries*>(
      ::google::monitoring::v3::TimeSeries::internal_default_instance());
  _CreateTimeSeriesError_default_instance_._instance.get_mutable()->status_ = const_cast< ::google::rpc::Status*>(
