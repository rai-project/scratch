...
void TableStruct::InitDefaultsImpl() {
  ...
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_Point_default_instance_);_TimeSeries_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_TimeSeries_default_instance_);_Point_default_instance_._instance.get_mutable()->interval_ = const_cast< ::google::monitoring::v3::TimeInterval*>(
      ::google::monitoring::v3::TimeInterval::internal_default_instance());
  _Point_default_instance_._instance.get_mutable()->value_ = const_cast< ::google::monitoring::v3::TypedValue*>(
      ::google::monitoring::v3::TypedValue::internal_default_instance());
  _TimeSeries_default_instance_._instance.get_mutable()->metric_ = const_cast< ::google::api::Metric*>(
      ::google::api::Metric::internal_default_instance());
  _TimeSeries_default_instance_._instance.get_mutable()->resource_ = const_cast< ::google::api::MonitoredResource*>(
