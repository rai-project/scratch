...
const ::google::protobuf::uint32 TableStruct::offsets[] GOOGLE_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
  ...
  offsetof(TypedValueDefaultTypeInternal, bool_value_),
  offsetof(TypedValueDefaultTypeInternal, int64_value_),
  offsetof(TypedValueDefaultTypeInternal, double_value_),
  offsetof(TypedValueDefaultTypeInternal, string_value_),
  offsetof(TypedValueDefaultTypeInternal, distribution_value_),
...
void TableStruct::InitDefaultsImpl() {
  ...
  _TypedValue_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_TypedValue_default_instance_);_TimeInterval_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_TimeInterval_default_instance_);_Aggregation_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_Aggregation_default_instance_);_TypedValue_default_instance_.bool_value_ = false;
  ...
  _TimeInterval_default_instance_._instance.get_mutable()->end_time_ = const_cast< ::google::protobuf::Timestamp*>(
      ::google::protobuf::Timestamp::internal_default_instance());
  _TimeInterval_default_instance_._instance.get_mutable()->start_time_ = const_cast< ::google::protobuf::Timestamp*>(
      ::google::protobuf::Timestamp::internal_default_instance());
  _Aggregation_default_instance_._instance.get_mutable()->alignment_period_ = const_cast< ::google::protobuf::Duration*>(
