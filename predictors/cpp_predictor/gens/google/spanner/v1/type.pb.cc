...
void TableStruct::InitDefaultsImpl() {
  ...
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_Type_default_instance_);_StructType_Field_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_StructType_Field_default_instance_);_StructType_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_StructType_default_instance_);_Type_default_instance_._instance.get_mutable()->array_element_type_ = const_cast< ::google::spanner::v1::Type*>(
      ::google::spanner::v1::Type::internal_default_instance());
  _Type_default_instance_._instance.get_mutable()->struct_type_ = const_cast< ::google::spanner::v1::StructType*>(
      ::google::spanner::v1::StructType::internal_default_instance());
  _StructType_Field_default_instance_._instance.get_mutable()->type_ = const_cast< ::google::spanner::v1::Type*>(
      ::google::spanner::v1::Type::internal_default_instance());
}
