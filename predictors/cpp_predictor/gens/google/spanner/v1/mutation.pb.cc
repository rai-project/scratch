...
const ::google::protobuf::uint32 TableStruct::offsets[] GOOGLE_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
  ...
  offsetof(MutationDefaultTypeInternal, insert_or_update_),
  offsetof(MutationDefaultTypeInternal, replace_),
...
void TableStruct::InitDefaultsImpl() {
  ...
  _Mutation_Write_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_Mutation_Write_default_instance_);_Mutation_Delete_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_Mutation_Delete_default_instance_);_Mutation_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_Mutation_default_instance_);_Mutation_Delete_default_instance_._instance.get_mutable()->key_set_ = const_cast< ::google::spanner::v1::KeySet*>(
