...
const ::google::protobuf::uint32 TableStruct::offsets[] GOOGLE_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
  ...
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(HttpRequest, protocol_),
};
...
void TableStruct::InitDefaultsImpl() {
  ...
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_HttpRequest_default_instance_);_HttpRequest_default_instance_._instance.get_mutable()->latency_ = const_cast< ::google::protobuf::Duration*>(
...
// string protocol = 15;
void HttpRequest::clear_protocol() {
  protocol_.ClearToEmptyNoArena(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
}
...
void HttpRequest::set_protocol(const ::std::string& value) {
...
#if LANG_CXX11
void HttpRequest::set_protocol(::std::string&& value) {
...
#endif
void HttpRequest::set_protocol(const char* value) {
  GOOGLE_DCHECK(value != NULL);
...
void HttpRequest::set_protocol(const char* value, size_t size) {
...
::std::string* HttpRequest::mutable_protocol() {
...
::std::string* HttpRequest::release_protocol() {
...
void HttpRequest::set_allocated_protocol(::std::string* protocol) {
  if (protocol != NULL) {
