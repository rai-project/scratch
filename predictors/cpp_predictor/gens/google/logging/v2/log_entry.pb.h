...
class LogEntry_LabelsEntry;
class LogEntry_LabelsEntryDefaultTypeInternal;
extern LogEntry_LabelsEntryDefaultTypeInternal _LogEntry_LabelsEntry_default_instance_;
}  // namespace v2
}  // namespace logging
}  // namespace google
...
class LogEntry : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:google.logging.v2.LogEntry) */ {
 public:
  ...
  void _slow_set_allocated_receive_timestamp(
      ::google::protobuf::Arena* message_arena, ::google::protobuf::Timestamp** receive_timestamp);
  ::google::protobuf::Timestamp* _slow_release_receive_timestamp();
  public:
 ...
 private:
  ...
  public:
  class LogEntry_LabelsEntry : public ::google::protobuf::internal::MapEntry<LogEntry_LabelsEntry, 
      ::std::string, ::std::string,
      ::google::protobuf::internal::WireFormatLite::TYPE_STRING,
      ::google::protobuf::internal::WireFormatLite::TYPE_STRING,
      0 > {
  public:
    typedef ::google::protobuf::internal::MapEntry<LogEntry_LabelsEntry, 
      ::std::string, ::std::string,
      ::google::protobuf::internal::WireFormatLite::TYPE_STRING,
      ::google::protobuf::internal::WireFormatLite::TYPE_STRING,
      0 > SuperType;
    LogEntry_LabelsEntry();
    LogEntry_LabelsEntry(::google::protobuf::Arena* arena);
    void MergeFrom(const ::google::protobuf::Message& other) PROTOBUF_FINAL;
    void MergeFrom(const LogEntry_LabelsEntry& other);
    static const Message* internal_default_instance() { return reinterpret_cast<const Message*>(&_LogEntry_LabelsEntry_default_instance_); }
...
inline void LogEntry::clear_receive_timestamp() {
