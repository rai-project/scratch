...
public:
 ::google::protobuf::internal::ExplicitlyConstructed<LogMetric::LogMetric_LabelExtractorsEntry>
     _instance;
...
file_level_metadata[0].reflection = LogMetric::LogMetric_LabelExtractorsEntry::CreateReflection(file_level_metadata[0].descriptor, _LogMetric_LabelExtractorsEntry_default_instance_._instance.get_mutable());
}
...
void TableStruct::InitDefaultsImpl() {
  ...
  _LogMetric_LabelExtractorsEntry_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_LogMetric_LabelExtractorsEntry_default_instance_);_LogMetric_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_LogMetric_default_instance_);_ListLogMetricsRequest_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_ListLogMetricsRequest_default_instance_);_ListLogMetricsResponse_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_ListLogMetricsResponse_default_instance_);_GetLogMetricRequest_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_GetLogMetricRequest_default_instance_);_CreateLogMetricRequest_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_CreateLogMetricRequest_default_instance_);_UpdateLogMetricRequest_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_UpdateLogMetricRequest_default_instance_);_DeleteLogMetricRequest_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_DeleteLogMetricRequest_default_instance_);_LogMetric_LabelExtractorsEntry_default_instance_._instance.get_mutable()->set_default_instance(_LogMetric_LabelExtractorsEntry_default_instance_._instance.get_mutable());
  _LogMetric_LabelExtractorsEntry_default_instance_._instance.get_mutable()->InitAsDefaultInstance();
  _LogMetric_default_instance_._instance.get_mutable()->metric_descriptor_ = const_cast< ::google::api::MetricDescriptor*>(
      ::google::api::MetricDescriptor::internal_default_instance());
  _LogMetric_default_instance_._instance.get_mutable()->bucket_options_ = const_cast< ::google::api::Distribution_BucketOptions*>(
      ::google::api::Distribution_BucketOptions::internal_default_instance());
  _CreateLogMetricRequest_default_instance_._instance.get_mutable()->metric_ = const_cast< ::google::logging::v2::LogMetric*>(
      ::google::logging::v2::LogMetric::internal_default_instance());
  _UpdateLogMetricRequest_default_instance_._instance.get_mutable()->metric_ = const_cast< ::google::logging::v2::LogMetric*>(
      ::google::logging::v2::LogMetric::internal_default_instance());
}
...
#if LANG_CXX11
void LogMetric::set_value_extractor(::std::string&& value) {
