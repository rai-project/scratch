...
void TableStruct::InitDefaultsImpl() {
  ...
  _UploadRef_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_UploadRef_default_instance_);_PhotoId_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_PhotoId_default_instance_);_Level_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_Level_default_instance_);_Pose_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_Pose_default_instance_);_Place_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_Place_default_instance_);_Connection_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_Connection_default_instance_);_Photo_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_Photo_default_instance_);_Pose_default_instance_._instance.get_mutable()->lat_lng_pair_ = const_cast< ::google::type::LatLng*>(
      ::google::type::LatLng::internal_default_instance());
  _Pose_default_instance_._instance.get_mutable()->level_ = const_cast< ::google::streetview::publish::v1::Level*>(
      ::google::streetview::publish::v1::Level::internal_default_instance());
  _Connection_default_instance_._instance.get_mutable()->target_ = const_cast< ::google::streetview::publish::v1::PhotoId*>(
      ::google::streetview::publish::v1::PhotoId::internal_default_instance());
  _Photo_default_instance_._instance.get_mutable()->photo_id_ = const_cast< ::google::streetview::publish::v1::PhotoId*>(
      ::google::streetview::publish::v1::PhotoId::internal_default_instance());
  _Photo_default_instance_._instance.get_mutable()->upload_reference_ = const_cast< ::google::streetview::publish::v1::UploadRef*>(
      ::google::streetview::publish::v1::UploadRef::internal_default_instance());
  _Photo_default_instance_._instance.get_mutable()->pose_ = const_cast< ::google::streetview::publish::v1::Pose*>(
      ::google::streetview::publish::v1::Pose::internal_default_instance());
  _Photo_default_instance_._instance.get_mutable()->capture_time_ = const_cast< ::google::protobuf::Timestamp*>(
