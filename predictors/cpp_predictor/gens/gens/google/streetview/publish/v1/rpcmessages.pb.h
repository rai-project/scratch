...
inline void CreatePhotoRequest::clear_photo() {
...
inline void PhotoResponse::clear_status() {
...
inline void PhotoResponse::clear_photo() {
  if (GetArenaNoVirtual() == NULL && photo_ != NULL) delete photo_;
  photo_ = NULL;
}
...
inline void ListPhotosResponse::clear_photos() {
  photos_.Clear();
}
...
inline void UpdatePhotoRequest::clear_photo() {
  if (GetArenaNoVirtual() == NULL && photo_ != NULL) delete photo_;
  photo_ = NULL;
}
...
inline void UpdatePhotoRequest::clear_update_mask() {
...
inline void BatchDeletePhotosResponse::clear_status() {
  status_.Clear();
}
