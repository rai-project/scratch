...
const ::google::protobuf::uint32 TableStruct::offsets[] GOOGLE_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
  ...
  offsetof(KeyRangeDefaultTypeInternal, start_closed_),
  offsetof(KeyRangeDefaultTypeInternal, start_open_),
  offsetof(KeyRangeDefaultTypeInternal, end_closed_),
  offsetof(KeyRangeDefaultTypeInternal, end_open_),
...
void TableStruct::InitDefaultsImpl() {
  ...
  _KeyRange_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_KeyRange_default_instance_);_KeySet_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_KeySet_default_instance_);_KeyRange_default_instance_.start_closed_ = const_cast< ::google::protobuf::ListValue*>(
