...
const ::google::protobuf::uint32 TableStruct::offsets[] GOOGLE_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
  ...
  ~0u,  // no _weak_field_map_
  offsetof(TransactionOptions_ReadOnlyDefaultTypeInternal, strong_),
  offsetof(TransactionOptions_ReadOnlyDefaultTypeInternal, min_read_timestamp_),
  offsetof(TransactionOptions_ReadOnlyDefaultTypeInternal, max_staleness_),
  offsetof(TransactionOptions_ReadOnlyDefaultTypeInternal, read_timestamp_),
  offsetof(TransactionOptions_ReadOnlyDefaultTypeInternal, exact_staleness_),
  ...
  ~0u,  // no _weak_field_map_
  offsetof(TransactionSelectorDefaultTypeInternal, single_use_),
  offsetof(TransactionSelectorDefaultTypeInternal, id_),
  offsetof(TransactionSelectorDefaultTypeInternal, begin_),
...
void TableStruct::InitDefaultsImpl() {
  ...
  _TransactionOptions_ReadWrite_default_instance_._instance.DefaultConstruct();
  ...
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_TransactionOptions_default_instance_);_Transaction_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_Transaction_default_instance_);_TransactionSelector_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_TransactionSelector_default_instance_);_TransactionOptions_ReadOnly_default_instance_.strong_ = false;
  ...
  _Transaction_default_instance_._instance.get_mutable()->read_timestamp_ = const_cast< ::google::protobuf::Timestamp*>(
      ::google::protobuf::Timestamp::internal_default_instance());
