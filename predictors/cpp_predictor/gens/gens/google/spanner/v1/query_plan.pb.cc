...
public:
 ::google::protobuf::internal::ExplicitlyConstructed<PlanNode_ShortRepresentation::PlanNode_ShortRepresentation_SubqueriesEntry>
     _instance;
...
file_level_metadata[1].reflection = PlanNode_ShortRepresentation::PlanNode_ShortRepresentation_SubqueriesEntry::CreateReflection(file_level_metadata[1].descriptor, _PlanNode_ShortRepresentation_SubqueriesEntry_default_instance_._instance.get_mutable());
}
...
void TableStruct::InitDefaultsImpl() {
  ...
  _PlanNode_ChildLink_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_PlanNode_ChildLink_default_instance_);_PlanNode_ShortRepresentation_SubqueriesEntry_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_PlanNode_ShortRepresentation_SubqueriesEntry_default_instance_);_PlanNode_ShortRepresentation_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_PlanNode_ShortRepresentation_default_instance_);_PlanNode_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_PlanNode_default_instance_);_QueryPlan_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_QueryPlan_default_instance_);_PlanNode_ShortRepresentation_SubqueriesEntry_default_instance_._instance.get_mutable()->set_default_instance(_PlanNode_ShortRepresentation_SubqueriesEntry_default_instance_._instance.get_mutable());
  _PlanNode_ShortRepresentation_SubqueriesEntry_default_instance_._instance.get_mutable()->InitAsDefaultInstance();
  _PlanNode_default_instance_._instance.get_mutable()->short_representation_ = const_cast< ::google::spanner::v1::PlanNode_ShortRepresentation*>(
      ::google::spanner::v1::PlanNode_ShortRepresentation::internal_default_instance());
  _PlanNode_default_instance_._instance.get_mutable()->metadata_ = const_cast< ::google::protobuf::Struct*>(
      ::google::protobuf::Struct::internal_default_instance());
  _PlanNode_default_instance_._instance.get_mutable()->execution_stats_ = const_cast< ::google::protobuf::Struct*>(
      ::google::protobuf::Struct::internal_default_instance());
}
