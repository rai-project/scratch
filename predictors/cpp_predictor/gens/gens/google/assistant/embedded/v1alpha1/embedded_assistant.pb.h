...
inline void ConverseRequest::set_allocated_config(::google::assistant::embedded::v1alpha1::ConverseConfig* config) {
  clear_converse_request();
  if (config) {
    set_has_config();
...
inline void ConverseResponse::clear_error() {
  if (has_error()) {
...
inline void ConverseResponse::set_allocated_error(::google::rpc::Status* error) {
  clear_converse_response();
  if (error) {
    set_has_error();
...
inline void ConverseResponse::set_allocated_audio_out(::google::assistant::embedded::v1alpha1::AudioOut* audio_out) {
  clear_converse_response();
  if (audio_out) {
    set_has_audio_out();
...
inline void ConverseResponse::set_allocated_result(::google::assistant::embedded::v1alpha1::ConverseResult* result) {
  clear_converse_response();
  if (result) {
    set_has_result();
