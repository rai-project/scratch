...
class WriteLogEntriesRequest_LabelsEntryDefaultTypeInternal {
public:
 ::google::protobuf::internal::ExplicitlyConstructed<WriteLogEntriesRequest::WriteLogEntriesRequest_LabelsEntry>
     _instance;
} _WriteLogEntriesRequest_LabelsEntry_default_instance_;
...
class WriteLogEntriesPartialErrors_LogEntryErrorsEntryDefaultTypeInternal {
public:
 ::google::protobuf::internal::ExplicitlyConstructed<WriteLogEntriesPartialErrors::WriteLogEntriesPartialErrors_LogEntryErrorsEntry>
     _instance;
} _WriteLogEntriesPartialErrors_LogEntryErrorsEntry_default_instance_;
...
const ::google::protobuf::uint32 TableStruct::offsets[] GOOGLE_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
  ...
  ~0u,  // no _weak_field_map_
  ~0u,  // no _has_bits_
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(WriteLogEntriesPartialErrors, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(WriteLogEntriesPartialErrors, log_entry_errors_),
  ~0u,  // no _has_bits_
...
static const ::google::protobuf::internal::MigrationSchema schemas[] GOOGLE_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
  ...
  { 6, -1, sizeof(WriteLogEntriesRequest)},
  { 16, -1, sizeof(WriteLogEntriesResponse)},
  { 21, -1, sizeof(WriteLogEntriesPartialErrors)},
  { 27, -1, sizeof(ListLogEntriesRequest)},
  { 38, -1, sizeof(ListLogEntriesResponse)},
  { 45, -1, sizeof(ListMonitoredResourceDescriptorsRequest)},
  { 52, -1, sizeof(ListMonitoredResourceDescriptorsResponse)},
  { 59, -1, sizeof(ListLogsRequest)},
  { 67, -1, sizeof(ListLogsResponse)},
};

static ::google::protobuf::Message const * const file_default_instances[] = {
  reinterpret_cast<const ::google::protobuf::Message*>(&_DeleteLogRequest_default_instance_),
  reinterpret_cast<const ::google::protobuf::Message*>(&_WriteLogEntriesRequest_LabelsEntry_default_instance_),
  ...
  reinterpret_cast<const ::google::protobuf::Message*>(&_WriteLogEntriesPartialErrors_LogEntryErrorsEntry_default_instance_),
  reinterpret_cast<const ::google::protobuf::Message*>(&_WriteLogEntriesPartialErrors_default_instance_),
...
file_level_metadata[1].reflection = WriteLogEntriesRequest::WriteLogEntriesRequest_LabelsEntry::CreateReflection(file_level_metadata[1].descriptor, _WriteLogEntriesRequest_LabelsEntry_default_instance_._instance.get_mutable());
file_level_metadata[4].reflection = WriteLogEntriesPartialErrors::WriteLogEntriesPartialErrors_LogEntryErrorsEntry::CreateReflection(file_level_metadata[4].descriptor, _WriteLogEntriesPartialErrors_LogEntryErrorsEntry_default_instance_._instance.get_mutable());
}
...
void TableStruct::InitDefaultsImpl() {
  ...
  _DeleteLogRequest_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_DeleteLogRequest_default_instance_);_WriteLogEntriesRequest_LabelsEntry_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_WriteLogEntriesRequest_LabelsEntry_default_instance_);_WriteLogEntriesRequest_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_WriteLogEntriesRequest_default_instance_);_WriteLogEntriesResponse_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_WriteLogEntriesResponse_default_instance_);_WriteLogEntriesPartialErrors_LogEntryErrorsEntry_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_WriteLogEntriesPartialErrors_LogEntryErrorsEntry_default_instance_);_WriteLogEntriesPartialErrors_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_WriteLogEntriesPartialErrors_default_instance_);_ListLogEntriesRequest_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_ListLogEntriesRequest_default_instance_);_ListLogEntriesResponse_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_ListLogEntriesResponse_default_instance_);_ListMonitoredResourceDescriptorsRequest_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_ListMonitoredResourceDescriptorsRequest_default_instance_);_ListMonitoredResourceDescriptorsResponse_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_ListMonitoredResourceDescriptorsResponse_default_instance_);_ListLogsRequest_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_ListLogsRequest_default_instance_);_ListLogsResponse_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_ListLogsResponse_default_instance_);_WriteLogEntriesRequest_LabelsEntry_default_instance_._instance.get_mutable()->set_default_instance(_WriteLogEntriesRequest_LabelsEntry_default_instance_._instance.get_mutable());
  _WriteLogEntriesRequest_LabelsEntry_default_instance_._instance.get_mutable()->InitAsDefaultInstance();
  _WriteLogEntriesRequest_default_instance_._instance.get_mutable()->resource_ = const_cast< ::google::api::MonitoredResource*>(
      ::google::api::MonitoredResource::internal_default_instance());
  _WriteLogEntriesPartialErrors_LogEntryErrorsEntry_default_instance_._instance.get_mutable()->set_default_instance(_WriteLogEntriesPartialErrors_LogEntryErrorsEntry_default_instance_._instance.get_mutable());
  _WriteLogEntriesPartialErrors_LogEntryErrorsEntry_default_instance_._instance.get_mutable()->InitAsDefaultInstance();
}
...
#if LANG_CXX11
void DeleteLogRequest::set_log_name(::std::string&& value) {
...
WriteLogEntriesRequest::WriteLogEntriesRequest_LabelsEntry::WriteLogEntriesRequest_LabelsEntry() {}
WriteLogEntriesRequest::WriteLogEntriesRequest_LabelsEntry::WriteLogEntriesRequest_LabelsEntry(::google::protobuf::Arena* arena) : SuperType(arena) {}
::google::protobuf::Metadata WriteLogEntriesRequest::WriteLogEntriesRequest_LabelsEntry::GetMetadata() const {
  protobuf_google_2flogging_2fv2_2flogging_2eproto::protobuf_AssignDescriptorsOnce();
  return protobuf_google_2flogging_2fv2_2flogging_2eproto::file_level_metadata[1];
}
void WriteLogEntriesRequest::WriteLogEntriesRequest_LabelsEntry::MergeFrom(
    const ::google::protobuf::Message& other) {
  ::google::protobuf::Message::MergeFrom(other);
}
void WriteLogEntriesRequest::WriteLogEntriesRequest_LabelsEntry::MergeFrom(const WriteLogEntriesRequest_LabelsEntry& other) {
...
#if LANG_CXX11
void WriteLogEntriesRequest::set_log_name(::std::string&& value) {
...
WriteLogEntriesPartialErrors::WriteLogEntriesPartialErrors_LogEntryErrorsEntry::WriteLogEntriesPartialErrors_LogEntryErrorsEntry() {}
WriteLogEntriesPartialErrors::WriteLogEntriesPartialErrors_LogEntryErrorsEntry::WriteLogEntriesPartialErrors_LogEntryErrorsEntry(::google::protobuf::Arena* arena) : SuperType(arena) {}
::google::protobuf::Metadata WriteLogEntriesPartialErrors::WriteLogEntriesPartialErrors_LogEntryErrorsEntry::GetMetadata() const {
  protobuf_google_2flogging_2fv2_2flogging_2eproto::protobuf_AssignDescriptorsOnce();
  return protobuf_google_2flogging_2fv2_2flogging_2eproto::file_level_metadata[4];
}
void WriteLogEntriesPartialErrors::WriteLogEntriesPartialErrors_LogEntryErrorsEntry::MergeFrom(
    const ::google::protobuf::Message& other) {
  ::google::protobuf::Message::MergeFrom(other);
}
void WriteLogEntriesPartialErrors::WriteLogEntriesPartialErrors_LogEntryErrorsEntry::MergeFrom(const WriteLogEntriesPartialErrors_LogEntryErrorsEntry& other) {
  MergeFromInternal(other);
}
  ...
  for (;;) {
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 1: {
        if (static_cast< ::google::protobuf::uint8>(tag) ==
            static_cast< ::google::protobuf::uint8>(10u /* 10 & 0xFF */)) {
          WriteLogEntriesPartialErrors_LogEntryErrorsEntry::Parser< ::google::protobuf::internal::MapField<
...
void WriteLogEntriesPartialErrors::SerializeWithCachedSizes(
  ...
  if (!this->log_entry_errors().empty()) {
    ...
    if (output->IsSerializationDeterministic() &&
      ...
      ::std::sort(&items[0], &items[static_cast<ptrdiff_t>(n)], Less());
      ::google::protobuf::scoped_ptr<WriteLogEntriesPartialErrors_LogEntryErrorsEntry> entry;
      for (size_type i = 0; i < n; i++) {
...
// map<int32, .google.rpc.Status> log_entry_errors = 1;
int WriteLogEntriesPartialErrors::log_entry_errors_size() const {
...
#if LANG_CXX11
void ListLogEntriesRequest::set_project_ids(int index, ::std::string&& value) {
  // @@protoc_insertion_point(field_set:google.logging.v2.ListLogEntriesRequest.project_ids)
...
#if LANG_CXX11
void ListLogEntriesRequest::add_project_ids(::std::string&& value) {
...
#if LANG_CXX11
void ListLogEntriesRequest::set_resource_names(int index, ::std::string&& value) {
  // @@protoc_insertion_point(field_set:google.logging.v2.ListLogEntriesRequest.resource_names)
...
#if LANG_CXX11
void ListLogEntriesRequest::add_resource_names(::std::string&& value) {
...
#if LANG_CXX11
void ListLogEntriesRequest::set_filter(::std::string&& value) {
...
#if LANG_CXX11
void ListLogEntriesRequest::set_order_by(::std::string&& value) {
...
#if LANG_CXX11
void ListLogEntriesRequest::set_page_token(::std::string&& value) {
...
#if LANG_CXX11
void ListLogEntriesResponse::set_next_page_token(::std::string&& value) {
...
#if LANG_CXX11
void ListLogsRequest::set_parent(::std::string&& value) {
...
#if LANG_CXX11
void ListLogsRequest::set_page_token(::std::string&& value) {
...
#if LANG_CXX11
void ListLogsResponse::set_log_names(int index, ::std::string&& value) {
  // @@protoc_insertion_point(field_set:google.logging.v2.ListLogsResponse.log_names)
...
#if LANG_CXX11
void ListLogsResponse::add_log_names(::std::string&& value) {
...
#if LANG_CXX11
void ListLogsResponse::set_next_page_token(::std::string&& value) {
