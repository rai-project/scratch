...
public:
 ::google::protobuf::internal::ExplicitlyConstructed<Profile::Profile_LabelsEntry>
     _instance;
...
public:
 ::google::protobuf::internal::ExplicitlyConstructed<Deployment::Deployment_LabelsEntry>
     _instance;
...
file_level_metadata[2].reflection = Profile::Profile_LabelsEntry::CreateReflection(file_level_metadata[2].descriptor, _Profile_LabelsEntry_default_instance_._instance.get_mutable());
file_level_metadata[4].reflection = Deployment::Deployment_LabelsEntry::CreateReflection(file_level_metadata[4].descriptor, _Deployment_LabelsEntry_default_instance_._instance.get_mutable());
}
...
void TableStruct::InitDefaultsImpl() {
  ...
  _CreateProfileRequest_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_CreateProfileRequest_default_instance_);_UpdateProfileRequest_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_UpdateProfileRequest_default_instance_);_Profile_LabelsEntry_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_Profile_LabelsEntry_default_instance_);_Profile_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_Profile_default_instance_);_Deployment_LabelsEntry_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_Deployment_LabelsEntry_default_instance_);_Deployment_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_Deployment_default_instance_);_CreateProfileRequest_default_instance_._instance.get_mutable()->deployment_ = const_cast< ::google::devtools::cloudprofiler::v2::Deployment*>(
      ::google::devtools::cloudprofiler::v2::Deployment::internal_default_instance());
  _CreateProfileRequest_default_instance_._instance.get_mutable()->profile_ = const_cast< ::google::devtools::cloudprofiler::v2::Profile*>(
      ::google::devtools::cloudprofiler::v2::Profile::internal_default_instance());
  _UpdateProfileRequest_default_instance_._instance.get_mutable()->profile_ = const_cast< ::google::devtools::cloudprofiler::v2::Profile*>(
      ::google::devtools::cloudprofiler::v2::Profile::internal_default_instance());
  _Profile_LabelsEntry_default_instance_._instance.get_mutable()->set_default_instance(_Profile_LabelsEntry_default_instance_._instance.get_mutable());
  _Profile_LabelsEntry_default_instance_._instance.get_mutable()->InitAsDefaultInstance();
  _Profile_default_instance_._instance.get_mutable()->deployment_ = const_cast< ::google::devtools::cloudprofiler::v2::Deployment*>(
      ::google::devtools::cloudprofiler::v2::Deployment::internal_default_instance());
  _Profile_default_instance_._instance.get_mutable()->duration_ = const_cast< ::google::protobuf::Duration*>(
      ::google::protobuf::Duration::internal_default_instance());
  _Deployment_LabelsEntry_default_instance_._instance.get_mutable()->set_default_instance(_Deployment_LabelsEntry_default_instance_._instance.get_mutable());
  _Deployment_LabelsEntry_default_instance_._instance.get_mutable()->InitAsDefaultInstance();
}
