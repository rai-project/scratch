 ...
 public:
  ...
  class Stub final : public StubInterface {
   ...
   private:
    ...
    const ::grpc::RpcMethod rpcmethod_CreateProfile_;
    const ::grpc::RpcMethod rpcmethod_UpdateProfile_;
  };
   ...
   public:
    WithStreamedUnaryMethod_CreateProfile() {
      ::grpc::Service::MarkMethodStreamed(0,
        new ::grpc::StreamedUnaryHandler< ::google::devtools::cloudprofiler::v2::CreateProfileRequest, ::google::devtools::cloudprofiler::v2::Profile>(std::bind(&WithStreamedUnaryMethod_CreateProfile<BaseClass>::StreamedCreateProfile, this, std::placeholders::_1, std::placeholders::_2)));
    }
   ...
   public:
    WithStreamedUnaryMethod_UpdateProfile() {
      ::grpc::Service::MarkMethodStreamed(1,
        new ::grpc::StreamedUnaryHandler< ::google::devtools::cloudprofiler::v2::UpdateProfileRequest, ::google::devtools::cloudprofiler::v2::Profile>(std::bind(&WithStreamedUnaryMethod_UpdateProfile<BaseClass>::StreamedUpdateProfile, this, std::placeholders::_1, std::placeholders::_2)));
    }
