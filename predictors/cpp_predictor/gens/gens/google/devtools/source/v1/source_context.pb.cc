...
public:
 ::google::protobuf::internal::ExplicitlyConstructed<ExtendedSourceContext::ExtendedSourceContext_LabelsEntry>
     _instance;
...
const ::google::protobuf::uint32 TableStruct::offsets[] GOOGLE_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
  ...
  offsetof(SourceContextDefaultTypeInternal, cloud_repo_),
  offsetof(SourceContextDefaultTypeInternal, cloud_workspace_),
  offsetof(SourceContextDefaultTypeInternal, gerrit_),
  offsetof(SourceContextDefaultTypeInternal, git_),
  ...
  offsetof(CloudRepoSourceContextDefaultTypeInternal, revision_id_),
  offsetof(CloudRepoSourceContextDefaultTypeInternal, alias_name_),
  offsetof(CloudRepoSourceContextDefaultTypeInternal, alias_context_),
  ...
  offsetof(GerritSourceContextDefaultTypeInternal, revision_id_),
  offsetof(GerritSourceContextDefaultTypeInternal, alias_name_),
  offsetof(GerritSourceContextDefaultTypeInternal, alias_context_),
  ...
  ~0u,  // no _weak_field_map_
  offsetof(RepoIdDefaultTypeInternal, project_repo_id_),
  offsetof(RepoIdDefaultTypeInternal, uid_),
...
file_level_metadata[1].reflection = ExtendedSourceContext::ExtendedSourceContext_LabelsEntry::CreateReflection(file_level_metadata[1].descriptor, _ExtendedSourceContext_LabelsEntry_default_instance_._instance.get_mutable());
}
...
void TableStruct::InitDefaultsImpl() {
  ...
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_SourceContext_default_instance_);_ExtendedSourceContext_LabelsEntry_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_ExtendedSourceContext_LabelsEntry_default_instance_);_ExtendedSourceContext_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_ExtendedSourceContext_default_instance_);_AliasContext_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_AliasContext_default_instance_);_CloudRepoSourceContext_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_CloudRepoSourceContext_default_instance_);_CloudWorkspaceSourceContext_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_CloudWorkspaceSourceContext_default_instance_);_GerritSourceContext_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_GerritSourceContext_default_instance_);_GitSourceContext_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_GitSourceContext_default_instance_);_RepoId_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_RepoId_default_instance_);_ProjectRepoId_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_ProjectRepoId_default_instance_);_CloudWorkspaceId_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_CloudWorkspaceId_default_instance_);_SourceContext_default_instance_.cloud_repo_ = const_cast< ::google::devtools::source::v1::CloudRepoSourceContext*>(
  ...
  _ExtendedSourceContext_LabelsEntry_default_instance_._instance.get_mutable()->set_default_instance(_ExtendedSourceContext_LabelsEntry_default_instance_._instance.get_mutable());
  _ExtendedSourceContext_LabelsEntry_default_instance_._instance.get_mutable()->InitAsDefaultInstance();
  _ExtendedSourceContext_default_instance_._instance.get_mutable()->context_ = const_cast< ::google::devtools::source::v1::SourceContext*>(
      ::google::devtools::source::v1::SourceContext::internal_default_instance());
  _CloudRepoSourceContext_default_instance_._instance.get_mutable()->repo_id_ = const_cast< ::google::devtools::source::v1::RepoId*>(
  ...
  _CloudWorkspaceSourceContext_default_instance_._instance.get_mutable()->workspace_id_ = const_cast< ::google::devtools::source::v1::CloudWorkspaceId*>(
  ...
  _RepoId_default_instance_.uid_.UnsafeSetDefault(
      &::google::protobuf::internal::GetEmptyStringAlreadyInited());
  _CloudWorkspaceId_default_instance_._instance.get_mutable()->repo_id_ = const_cast< ::google::devtools::source::v1::RepoId*>(
      ::google::devtools::source::v1::RepoId::internal_default_instance());
}
