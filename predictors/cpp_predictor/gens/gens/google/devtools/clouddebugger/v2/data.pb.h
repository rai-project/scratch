...
class Breakpoint_LabelsEntry;
class Breakpoint_LabelsEntryDefaultTypeInternal;
extern Breakpoint_LabelsEntryDefaultTypeInternal _Breakpoint_LabelsEntry_default_instance_;
class Debuggee;
class DebuggeeDefaultTypeInternal;
extern DebuggeeDefaultTypeInternal _Debuggee_default_instance_;
class Debuggee_LabelsEntry;
class Debuggee_LabelsEntryDefaultTypeInternal;
extern Debuggee_LabelsEntryDefaultTypeInternal _Debuggee_LabelsEntry_default_instance_;
class FormatMessage;
...
class Breakpoint : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:google.devtools.clouddebugger.v2.Breakpoint) */ {
 ...
 private:
  ...
  public:
  class Breakpoint_LabelsEntry : public ::google::protobuf::internal::MapEntry<Breakpoint_LabelsEntry, 
      ::std::string, ::std::string,
      ::google::protobuf::internal::WireFormatLite::TYPE_STRING,
      ::google::protobuf::internal::WireFormatLite::TYPE_STRING,
      0 > {
  public:
    typedef ::google::protobuf::internal::MapEntry<Breakpoint_LabelsEntry, 
      ::std::string, ::std::string,
      ::google::protobuf::internal::WireFormatLite::TYPE_STRING,
      ::google::protobuf::internal::WireFormatLite::TYPE_STRING,
      0 > SuperType;
    Breakpoint_LabelsEntry();
    Breakpoint_LabelsEntry(::google::protobuf::Arena* arena);
    void MergeFrom(const ::google::protobuf::Message& other) PROTOBUF_FINAL;
    void MergeFrom(const Breakpoint_LabelsEntry& other);
    static const Message* internal_default_instance() { return reinterpret_cast<const Message*>(&_Breakpoint_LabelsEntry_default_instance_); }
...
class Debuggee : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:google.devtools.clouddebugger.v2.Debuggee) */ {
 ...
 private:
  ...
  public:
  class Debuggee_LabelsEntry : public ::google::protobuf::internal::MapEntry<Debuggee_LabelsEntry, 
      ::std::string, ::std::string,
      ::google::protobuf::internal::WireFormatLite::TYPE_STRING,
      ::google::protobuf::internal::WireFormatLite::TYPE_STRING,
      0 > {
  public:
    typedef ::google::protobuf::internal::MapEntry<Debuggee_LabelsEntry, 
      ::std::string, ::std::string,
      ::google::protobuf::internal::WireFormatLite::TYPE_STRING,
      ::google::protobuf::internal::WireFormatLite::TYPE_STRING,
      0 > SuperType;
    Debuggee_LabelsEntry();
    Debuggee_LabelsEntry(::google::protobuf::Arena* arena);
    void MergeFrom(const ::google::protobuf::Message& other) PROTOBUF_FINAL;
    void MergeFrom(const Debuggee_LabelsEntry& other);
    static const Message* internal_default_instance() { return reinterpret_cast<const Message*>(&_Debuggee_LabelsEntry_default_instance_); }
    ::google::protobuf::Metadata GetMetadata() const;
  };
  private:
  ::google::protobuf::internal::MapField<
