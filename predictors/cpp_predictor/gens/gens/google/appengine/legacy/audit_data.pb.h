...
class AuditData_EventDataEntry;
class AuditData_EventDataEntryDefaultTypeInternal;
extern AuditData_EventDataEntryDefaultTypeInternal _AuditData_EventDataEntry_default_instance_;
}  // namespace legacy
}  // namespace appengine
}  // namespace google
...
class AuditData : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:google.appengine.legacy.AuditData) */ {
 ...
 private:
  ...
  public:
  class AuditData_EventDataEntry : public ::google::protobuf::internal::MapEntry<AuditData_EventDataEntry, 
      ::std::string, ::std::string,
      ::google::protobuf::internal::WireFormatLite::TYPE_STRING,
      ::google::protobuf::internal::WireFormatLite::TYPE_STRING,
      0 > {
  public:
    typedef ::google::protobuf::internal::MapEntry<AuditData_EventDataEntry, 
      ::std::string, ::std::string,
      ::google::protobuf::internal::WireFormatLite::TYPE_STRING,
      ::google::protobuf::internal::WireFormatLite::TYPE_STRING,
      0 > SuperType;
    AuditData_EventDataEntry();
    AuditData_EventDataEntry(::google::protobuf::Arena* arena);
    void MergeFrom(const ::google::protobuf::Message& other) PROTOBUF_FINAL;
    void MergeFrom(const AuditData_EventDataEntry& other);
    static const Message* internal_default_instance() { return reinterpret_cast<const Message*>(&_AuditData_EventDataEntry_default_instance_); }
