...
namespace appengine {
namespace legacy {
class AuditData_EventDataEntryDefaultTypeInternal {
public:
 ::google::protobuf::internal::ExplicitlyConstructed<AuditData::AuditData_EventDataEntry>
     _instance;
...
file_level_metadata[0].reflection = AuditData::AuditData_EventDataEntry::CreateReflection(file_level_metadata[0].descriptor, _AuditData_EventDataEntry_default_instance_._instance.get_mutable());
}
...
void TableStruct::InitDefaultsImpl() {
  ...
  _AuditData_EventDataEntry_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_AuditData_EventDataEntry_default_instance_);_AuditData_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_AuditData_default_instance_);_AuditData_EventDataEntry_default_instance_._instance.get_mutable()->set_default_instance(_AuditData_EventDataEntry_default_instance_._instance.get_mutable());
  _AuditData_EventDataEntry_default_instance_._instance.get_mutable()->InitAsDefaultInstance();
}
