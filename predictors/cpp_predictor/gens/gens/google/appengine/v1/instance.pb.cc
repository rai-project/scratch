...
void TableStruct::InitDefaultsImpl() {
  ...
  _Instance_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_Instance_default_instance_);_Instance_default_instance_._instance.get_mutable()->start_time_ = const_cast< ::google::protobuf::Timestamp*>(
