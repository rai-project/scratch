...
class Version_BetaSettingsEntry;
class Version_BetaSettingsEntryDefaultTypeInternal;
extern Version_BetaSettingsEntryDefaultTypeInternal _Version_BetaSettingsEntry_default_instance_;
class Version_EnvVariablesEntry;
class Version_EnvVariablesEntryDefaultTypeInternal;
extern Version_EnvVariablesEntryDefaultTypeInternal _Version_EnvVariablesEntry_default_instance_;
}  // namespace v1
}  // namespace appengine
}  // namespace google
...
class Version : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:google.appengine.v1.Version) */ {
 ...
 private:
  ...
  public:
  class Version_BetaSettingsEntry : public ::google::protobuf::internal::MapEntry<Version_BetaSettingsEntry, 
      ::std::string, ::std::string,
      ::google::protobuf::internal::WireFormatLite::TYPE_STRING,
      ::google::protobuf::internal::WireFormatLite::TYPE_STRING,
      0 > {
  public:
    typedef ::google::protobuf::internal::MapEntry<Version_BetaSettingsEntry, 
      ::std::string, ::std::string,
      ::google::protobuf::internal::WireFormatLite::TYPE_STRING,
      ::google::protobuf::internal::WireFormatLite::TYPE_STRING,
      0 > SuperType;
    Version_BetaSettingsEntry();
    Version_BetaSettingsEntry(::google::protobuf::Arena* arena);
    void MergeFrom(const ::google::protobuf::Message& other) PROTOBUF_FINAL;
    void MergeFrom(const Version_BetaSettingsEntry& other);
    static const Message* internal_default_instance() { return reinterpret_cast<const Message*>(&_Version_BetaSettingsEntry_default_instance_); }
  ...
  public:
  class Version_EnvVariablesEntry : public ::google::protobuf::internal::MapEntry<Version_EnvVariablesEntry, 
      ::std::string, ::std::string,
      ::google::protobuf::internal::WireFormatLite::TYPE_STRING,
      ::google::protobuf::internal::WireFormatLite::TYPE_STRING,
      0 > {
  public:
    typedef ::google::protobuf::internal::MapEntry<Version_EnvVariablesEntry, 
      ::std::string, ::std::string,
      ::google::protobuf::internal::WireFormatLite::TYPE_STRING,
      ::google::protobuf::internal::WireFormatLite::TYPE_STRING,
      0 > SuperType;
    Version_EnvVariablesEntry();
    Version_EnvVariablesEntry(::google::protobuf::Arena* arena);
    void MergeFrom(const ::google::protobuf::Message& other) PROTOBUF_FINAL;
    void MergeFrom(const Version_EnvVariablesEntry& other);
    static const Message* internal_default_instance() { return reinterpret_cast<const Message*>(&_Version_EnvVariablesEntry_default_instance_); }
    ::google::protobuf::Metadata GetMetadata() const;
  };
  private:
  ::google::protobuf::internal::MapField<
