...
class Deployment_FilesEntry;
class Deployment_FilesEntryDefaultTypeInternal;
extern Deployment_FilesEntryDefaultTypeInternal _Deployment_FilesEntry_default_instance_;
class FileInfo;
...
class Deployment : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:google.appengine.v1.Deployment) */ {
 ...
 private:
  ...
  public:
  class Deployment_FilesEntry : public ::google::protobuf::internal::MapEntry<Deployment_FilesEntry, 
      ::std::string, ::google::appengine::v1::FileInfo,
      ::google::protobuf::internal::WireFormatLite::TYPE_STRING,
      ::google::protobuf::internal::WireFormatLite::TYPE_MESSAGE,
      0 > {
  public:
    typedef ::google::protobuf::internal::MapEntry<Deployment_FilesEntry, 
      ::std::string, ::google::appengine::v1::FileInfo,
      ::google::protobuf::internal::WireFormatLite::TYPE_STRING,
      ::google::protobuf::internal::WireFormatLite::TYPE_MESSAGE,
      0 > SuperType;
    Deployment_FilesEntry();
    Deployment_FilesEntry(::google::protobuf::Arena* arena);
    void MergeFrom(const ::google::protobuf::Message& other) PROTOBUF_FINAL;
    void MergeFrom(const Deployment_FilesEntry& other);
    static const Message* internal_default_instance() { return reinterpret_cast<const Message*>(&_Deployment_FilesEntry_default_instance_); }
