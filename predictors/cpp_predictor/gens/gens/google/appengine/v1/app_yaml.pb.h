...
class StaticFilesHandler_HttpHeadersEntry;
class StaticFilesHandler_HttpHeadersEntryDefaultTypeInternal;
extern StaticFilesHandler_HttpHeadersEntryDefaultTypeInternal _StaticFilesHandler_HttpHeadersEntry_default_instance_;
class UrlMap;
...
class StaticFilesHandler : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:google.appengine.v1.StaticFilesHandler) */ {
 ...
 private:
  ...
  ::google::protobuf::internal::InternalMetadataWithArena _internal_metadata_;
  public:
  class StaticFilesHandler_HttpHeadersEntry : public ::google::protobuf::internal::MapEntry<StaticFilesHandler_HttpHeadersEntry, 
      ::std::string, ::std::string,
      ::google::protobuf::internal::WireFormatLite::TYPE_STRING,
      ::google::protobuf::internal::WireFormatLite::TYPE_STRING,
      0 > {
  public:
    typedef ::google::protobuf::internal::MapEntry<StaticFilesHandler_HttpHeadersEntry, 
      ::std::string, ::std::string,
      ::google::protobuf::internal::WireFormatLite::TYPE_STRING,
      ::google::protobuf::internal::WireFormatLite::TYPE_STRING,
      0 > SuperType;
    StaticFilesHandler_HttpHeadersEntry();
    StaticFilesHandler_HttpHeadersEntry(::google::protobuf::Arena* arena);
    void MergeFrom(const ::google::protobuf::Message& other) PROTOBUF_FINAL;
    void MergeFrom(const StaticFilesHandler_HttpHeadersEntry& other);
    static const Message* internal_default_instance() { return reinterpret_cast<const Message*>(&_StaticFilesHandler_HttpHeadersEntry_default_instance_); }
