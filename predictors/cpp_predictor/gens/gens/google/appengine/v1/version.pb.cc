...
namespace appengine {
namespace v1 {
class Version_BetaSettingsEntryDefaultTypeInternal {
public:
 ::google::protobuf::internal::ExplicitlyConstructed<Version::Version_BetaSettingsEntry>
     _instance;
} _Version_BetaSettingsEntry_default_instance_;
class Version_EnvVariablesEntryDefaultTypeInternal {
public:
 ::google::protobuf::internal::ExplicitlyConstructed<Version::Version_EnvVariablesEntry>
     _instance;
...
const ::google::protobuf::uint32 TableStruct::offsets[] GOOGLE_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
  ...
  offsetof(VersionDefaultTypeInternal, automatic_scaling_),
  offsetof(VersionDefaultTypeInternal, basic_scaling_),
  offsetof(VersionDefaultTypeInternal, manual_scaling_),
...
file_level_metadata[0].reflection = Version::Version_BetaSettingsEntry::CreateReflection(file_level_metadata[0].descriptor, _Version_BetaSettingsEntry_default_instance_._instance.get_mutable());
file_level_metadata[1].reflection = Version::Version_EnvVariablesEntry::CreateReflection(file_level_metadata[1].descriptor, _Version_EnvVariablesEntry_default_instance_._instance.get_mutable());
}
...
void TableStruct::InitDefaultsImpl() {
  ...
  _Version_BetaSettingsEntry_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_Version_BetaSettingsEntry_default_instance_);_Version_EnvVariablesEntry_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_Version_EnvVariablesEntry_default_instance_);_Version_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_Version_default_instance_);_AutomaticScaling_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_AutomaticScaling_default_instance_);_BasicScaling_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_BasicScaling_default_instance_);_ManualScaling_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_ManualScaling_default_instance_);_CpuUtilization_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_CpuUtilization_default_instance_);_RequestUtilization_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_RequestUtilization_default_instance_);_DiskUtilization_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_DiskUtilization_default_instance_);_NetworkUtilization_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_NetworkUtilization_default_instance_);_Network_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_Network_default_instance_);_Resources_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_Resources_default_instance_);_Version_BetaSettingsEntry_default_instance_._instance.get_mutable()->set_default_instance(_Version_BetaSettingsEntry_default_instance_._instance.get_mutable());
  _Version_BetaSettingsEntry_default_instance_._instance.get_mutable()->InitAsDefaultInstance();
  _Version_EnvVariablesEntry_default_instance_._instance.get_mutable()->set_default_instance(_Version_EnvVariablesEntry_default_instance_._instance.get_mutable());
  _Version_EnvVariablesEntry_default_instance_._instance.get_mutable()->InitAsDefaultInstance();
  ...
  _Version_default_instance_._instance.get_mutable()->network_ = const_cast< ::google::appengine::v1::Network*>(
      ::google::appengine::v1::Network::internal_default_instance());
  _Version_default_instance_._instance.get_mutable()->resources_ = const_cast< ::google::appengine::v1::Resources*>(
      ::google::appengine::v1::Resources::internal_default_instance());
  _Version_default_instance_._instance.get_mutable()->create_time_ = const_cast< ::google::protobuf::Timestamp*>(
      ::google::protobuf::Timestamp::internal_default_instance());
  _Version_default_instance_._instance.get_mutable()->api_config_ = const_cast< ::google::appengine::v1::ApiConfigHandler*>(
      ::google::appengine::v1::ApiConfigHandler::internal_default_instance());
  _Version_default_instance_._instance.get_mutable()->default_expiration_ = const_cast< ::google::protobuf::Duration*>(
      ::google::protobuf::Duration::internal_default_instance());
  _Version_default_instance_._instance.get_mutable()->health_check_ = const_cast< ::google::appengine::v1::HealthCheck*>(
      ::google::appengine::v1::HealthCheck::internal_default_instance());
  _Version_default_instance_._instance.get_mutable()->deployment_ = const_cast< ::google::appengine::v1::Deployment*>(
      ::google::appengine::v1::Deployment::internal_default_instance());
  _AutomaticScaling_default_instance_._instance.get_mutable()->cool_down_period_ = const_cast< ::google::protobuf::Duration*>(
      ::google::protobuf::Duration::internal_default_instance());
  _AutomaticScaling_default_instance_._instance.get_mutable()->cpu_utilization_ = const_cast< ::google::appengine::v1::CpuUtilization*>(
      ::google::appengine::v1::CpuUtilization::internal_default_instance());
  _AutomaticScaling_default_instance_._instance.get_mutable()->max_pending_latency_ = const_cast< ::google::protobuf::Duration*>(
      ::google::protobuf::Duration::internal_default_instance());
  _AutomaticScaling_default_instance_._instance.get_mutable()->min_pending_latency_ = const_cast< ::google::protobuf::Duration*>(
      ::google::protobuf::Duration::internal_default_instance());
  _AutomaticScaling_default_instance_._instance.get_mutable()->request_utilization_ = const_cast< ::google::appengine::v1::RequestUtilization*>(
      ::google::appengine::v1::RequestUtilization::internal_default_instance());
  _AutomaticScaling_default_instance_._instance.get_mutable()->disk_utilization_ = const_cast< ::google::appengine::v1::DiskUtilization*>(
      ::google::appengine::v1::DiskUtilization::internal_default_instance());
  _AutomaticScaling_default_instance_._instance.get_mutable()->network_utilization_ = const_cast< ::google::appengine::v1::NetworkUtilization*>(
      ::google::appengine::v1::NetworkUtilization::internal_default_instance());
  _BasicScaling_default_instance_._instance.get_mutable()->idle_timeout_ = const_cast< ::google::protobuf::Duration*>(
      ::google::protobuf::Duration::internal_default_instance());
  _CpuUtilization_default_instance_._instance.get_mutable()->aggregation_window_length_ = const_cast< ::google::protobuf::Duration*>(
      ::google::protobuf::Duration::internal_default_instance());
}
