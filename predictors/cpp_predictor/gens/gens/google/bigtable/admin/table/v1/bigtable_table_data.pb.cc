...
public:
 ::google::protobuf::internal::ExplicitlyConstructed<Table::Table_ColumnFamiliesEntry>
     _instance;
...
const ::google::protobuf::uint32 TableStruct::offsets[] GOOGLE_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
  ...
  ~0u,  // no _weak_field_map_
  offsetof(GcRuleDefaultTypeInternal, max_num_versions_),
  offsetof(GcRuleDefaultTypeInternal, max_age_),
  offsetof(GcRuleDefaultTypeInternal, intersection_),
  offsetof(GcRuleDefaultTypeInternal, union__),
...
file_level_metadata[0].reflection = Table::Table_ColumnFamiliesEntry::CreateReflection(file_level_metadata[0].descriptor, _Table_ColumnFamiliesEntry_default_instance_._instance.get_mutable());
}
...
void TableStruct::InitDefaultsImpl() {
  ...
  _Table_ColumnFamiliesEntry_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_Table_ColumnFamiliesEntry_default_instance_);_Table_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_Table_default_instance_);_ColumnFamily_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_ColumnFamily_default_instance_);_GcRule_Intersection_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_GcRule_Intersection_default_instance_);_GcRule_Union_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_GcRule_Union_default_instance_);_GcRule_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_GcRule_default_instance_);_Table_ColumnFamiliesEntry_default_instance_._instance.get_mutable()->set_default_instance(_Table_ColumnFamiliesEntry_default_instance_._instance.get_mutable());
  _Table_ColumnFamiliesEntry_default_instance_._instance.get_mutable()->InitAsDefaultInstance();
  _Table_default_instance_._instance.get_mutable()->current_operation_ = const_cast< ::google::longrunning::Operation*>(
      ::google::longrunning::Operation::internal_default_instance());
  _ColumnFamily_default_instance_._instance.get_mutable()->gc_rule_ = const_cast< ::google::bigtable::admin::table::v1::GcRule*>(
