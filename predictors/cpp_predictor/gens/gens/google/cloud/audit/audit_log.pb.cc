...
void TableStruct::InitDefaultsImpl() {
  ...
  _AuditLog_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_AuditLog_default_instance_);_AuthenticationInfo_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_AuthenticationInfo_default_instance_);_AuthorizationInfo_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_AuthorizationInfo_default_instance_);_RequestMetadata_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_RequestMetadata_default_instance_);_AuditLog_default_instance_._instance.get_mutable()->status_ = const_cast< ::google::rpc::Status*>(
      ::google::rpc::Status::internal_default_instance());
  _AuditLog_default_instance_._instance.get_mutable()->authentication_info_ = const_cast< ::google::cloud::audit::AuthenticationInfo*>(
      ::google::cloud::audit::AuthenticationInfo::internal_default_instance());
  _AuditLog_default_instance_._instance.get_mutable()->request_metadata_ = const_cast< ::google::cloud::audit::RequestMetadata*>(
      ::google::cloud::audit::RequestMetadata::internal_default_instance());
  _AuditLog_default_instance_._instance.get_mutable()->request_ = const_cast< ::google::protobuf::Struct*>(
      ::google::protobuf::Struct::internal_default_instance());
  _AuditLog_default_instance_._instance.get_mutable()->response_ = const_cast< ::google::protobuf::Struct*>(
      ::google::protobuf::Struct::internal_default_instance());
  _AuditLog_default_instance_._instance.get_mutable()->service_data_ = const_cast< ::google::protobuf::Any*>(
