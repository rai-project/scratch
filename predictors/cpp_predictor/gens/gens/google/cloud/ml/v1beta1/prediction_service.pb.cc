...
void TableStruct::InitDefaultsImpl() {
  ...
  _PredictRequest_default_instance_._instance.DefaultConstruct();
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_PredictRequest_default_instance_);_PredictRequest_default_instance_._instance.get_mutable()->http_body_ = const_cast< ::google::api::HttpBody*>(
