...
const ::google::protobuf::uint32 TableStruct::offsets[] GOOGLE_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
  ...
  offsetof(LogEntryDefaultTypeInternal, struct_payload_),
...
void TableStruct::InitDefaultsImpl() {
  ...
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_LogEntry_default_instance_);_LogEntry_LabelsEntry_default_instance_._instance.get_mutable()->set_default_instance(_LogEntry_LabelsEntry_default_instance_._instance.get_mutable());
