...
class Rollout_TrafficPercentStrategy_PercentagesEntry;
class Rollout_TrafficPercentStrategy_PercentagesEntryDefaultTypeInternal;
extern Rollout_TrafficPercentStrategy_PercentagesEntryDefaultTypeInternal _Rollout_TrafficPercentStrategy_PercentagesEntry_default_instance_;
}  // namespace v1
}  // namespace servicemanagement
}  // namespace api
}  // namespace google
...
class Rollout_TrafficPercentStrategy : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:google.api.servicemanagement.v1.Rollout.TrafficPercentStrategy) */ {
 ...
 private:
  ...
  ::google::protobuf::internal::InternalMetadataWithArena _internal_metadata_;
  public:
  class Rollout_TrafficPercentStrategy_PercentagesEntry : public ::google::protobuf::internal::MapEntry<Rollout_TrafficPercentStrategy_PercentagesEntry, 
      ::std::string, double,
      ::google::protobuf::internal::WireFormatLite::TYPE_STRING,
      ::google::protobuf::internal::WireFormatLite::TYPE_DOUBLE,
      0 > {
  public:
    typedef ::google::protobuf::internal::MapEntry<Rollout_TrafficPercentStrategy_PercentagesEntry, 
      ::std::string, double,
      ::google::protobuf::internal::WireFormatLite::TYPE_STRING,
      ::google::protobuf::internal::WireFormatLite::TYPE_DOUBLE,
      0 > SuperType;
    Rollout_TrafficPercentStrategy_PercentagesEntry();
    Rollout_TrafficPercentStrategy_PercentagesEntry(::google::protobuf::Arena* arena);
    void MergeFrom(const ::google::protobuf::Message& other) PROTOBUF_FINAL;
    void MergeFrom(const Rollout_TrafficPercentStrategy_PercentagesEntry& other);
    static const Message* internal_default_instance() { return reinterpret_cast<const Message*>(&_Rollout_TrafficPercentStrategy_PercentagesEntry_default_instance_); }
