...
inline void TransactionOptions::set_allocated_read_write(::google::datastore::v1::TransactionOptions_ReadWrite* read_write) {
  clear_mode();
  if (read_write) {
    set_has_read_write();
...
inline void TransactionOptions::set_allocated_read_only(::google::datastore::v1::TransactionOptions_ReadOnly* read_only) {
  clear_mode();
  if (read_only) {
    set_has_read_only();
